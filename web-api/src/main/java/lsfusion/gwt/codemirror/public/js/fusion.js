CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ACTIVE ACTIVATE ADDFORM AFTER " +
                           ...
                           "CONTAINERH CONTAINERV CONTEXTFILTER CSV CUSTOM CUSTOMLINK FILE CYCLES DATA DBF DEFAULT DEFAULTCOMPARE DELAY DELETE " +
                           ...
                           "FILTERS FINALLY FIRST FIXED FOCUS FOLDER FOOTER FOR FORCE FOREGROUND " +
                           ...
                           "INDEXED INIT INITFILTER INTERNAL INLINE INPUT IS JAVA JOIN JSON KEYPRESS LAST LEFT LENGTH LIKE LIMIT " +
