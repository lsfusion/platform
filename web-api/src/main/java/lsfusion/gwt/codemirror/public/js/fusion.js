CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ACTIVE ACTIVATE ADD ADDFORM ADDSESSIONFORM AFTER " +
                           ...
                           "CONTAINERH CONTAINERV CONTEXTFILTER CSV CUSTOM CUSTOMLINK CUSTOMFILE CYCLES DATA DBF DEFAULT DELAY DELETE " +
                           ...
                           "EDITSESSIONFORM ELSE EMAIL END EQUAL EVAL EVENTID EVENTS EXCELFILE EXCELLINK " +
                           ...
                           "PANEL PARENT PARTITION PDF PDFFILE PDFLINK PERIOD PERSISTENT PG POSITION " +
                           ...
                           "ROUND RTF SAVEFILE SCHEDULE SCROLL SEEK SELECTOR SESSION SET SETCHANGED SHORTCUT SHOW SHOWDROP " +
