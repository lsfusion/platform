CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ADD ADDFORM ADDOBJ ADDSESSIONFORM AFTER " + 
                           "AGGR AGGPROP AND APPLY AS ASC ASONCHANGE ASONCHANGEWYS ASONEDIT ASSIGN ASYNCUPDATE ATTACH " +
                           ...
                           "NAVIGATOR NEW NEWSESSION NEWTHREAD NO NOT NULL NUMERIC OBJECT " +
