CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ADD ADDFORM ADDOBJ ADDSESSIONFORM AFTER " + 
                           ...
                           "AUTOAPPLY AUTOREFRESH AUTOSET BACKGROUND BCC BEFORE BOTTOM BREAK BY CANCEL CASCADE " +
                           ...
                           "INDEXED INIT INLINE INPUT INTERSECT IS JOIN LAST LEADING LEFT LENGTH LIMIT " +
