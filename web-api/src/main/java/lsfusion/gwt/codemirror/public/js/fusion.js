CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ADD ADDFORM ADDOBJ ADDSESSIONFORM AFTER " +
                           ...
                           "FORM FORMACTIVE FORMS FORMULA FROM FULL FULLSCREEN GOAFTER GRID GROUP HALIGN HEADER " +
                           ...
                           "NAVIGATOR NEW NEWSESSION NEWTHREAD NO NOCANCEL NOCLOSE NOHEADER NOHINT NOT NULL NUMERIC OBJECT " +
                           ...
                           "SUM TABBED TABLE TABACTIVE TEXTHALIGN TEXTVALIGN THEN TIME TO TODRAW " +
