CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ADD ADDFORM ADDOBJ ADDSESSIONFORM AFTER " + 
                           ...
                           "AUTOAPPLY AUTOSET BACKGROUND BCC BEFORE BOTTOM BREAK BY CANCEL CASCADE " +
                           "CASE CC CENTER CHANGE CHANGECLASS CHANGED CHANGEWYS CHECK " + 
                           "CHECKED CLASS CLOSE COLOR COLUMNS CONCAT CONFIRM CONSTRAINT " + 
                           "CONTAINERH CONTAINERV CONTAINERVH CONTEXTFILTER CUSTOM CUSTOMFILE CYCLES DATA DEFAULT DELETE " +
                           ...
                           "FORM FORMS FORMULA FROM FULLSCREEN GRID GROUP HALIGN HEADER " +
                           "HIDE HIDESCROLLBARS HIDETITLE HINTNOUPDATE HINTTABLE HORIZONTAL " + 
                           "HTML IF IMAGE IMAGEFILE IMPOSSIBLE IN INCREMENT INDEX " + 
                           "INDEXED INIT INLINE INPUT INTERSECT IS JOIN LAST LEFT LENGTH LIMIT " +
                           ...
                           "PROPORTION QUERYOK QUERYCLOSE READONLY READONLYIF RECURSION REGEXP REMOVE " +
                           "REPORTFILE REQUEST REQUIRE RESOLVE RETURN RGB RIGHT RIGHTBOTTOM " + 
                           "ROUND RTF SELECTION SELECTOR SESSION SET SETCHANGED SHORTCUT SHOW SHOWDROP " +
