...
public class DataCellView extends JPanel implements CellView {
    ...
    public DataCellView(final ClientFormController iform, final ClientPropertyDraw iproperty, ClientGroupObjectValue icolumnKey) {
        ...
        table = new DataCellViewTable(iform, this, columnKey, property);
    ...
    public boolean equals(Object o) {
        return o instanceof DataCellView && ((DataCellView) o).property.equals(property) && ((DataCellView) o).columnKey.equals(columnKey);
    }
