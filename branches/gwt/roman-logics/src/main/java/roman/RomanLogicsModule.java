...
public class RomanLogicsModule extends LogicsModule {
    ...
    private LP typeDutyFreight;
    private LP sidTypeDutyFreight;
    ...
    public void initProperties() {
        ...
        countRelationCustomCategory10 = addSGProp(baseGroup, "countRelationCustomCategory10", "Кол-во групп", addJProp(baseLM.and1, addCProp(IntegerClass.instance, 1), relationCustomCategory10SubCategory, 1, 2), 1);
        ...
        dutyPercentCustomCategory10TypeDuty = addDProp("dutyPercentCustomCategory10TypeDuty", "Пошлина (%)", DoubleClass.instance, customCategory10, typeDuty);
        dutySumCustomCategory10TypeDuty = addDProp("dutySumCustomCategory10TypeDuty", "Пошлина (евро)", DoubleClass.instance, customCategory10, typeDuty);
...
//                routeToFillShipmentBarcode, 1, 2);
        ...
        typeDutyFreight = addDProp(idGroup, "typeDutyFreight", "Тип пошлины фрахта (ИД)", typeDuty, freight);
        sidTypeDutyFreight = addJProp(baseGroup, "sidTypeDutyFreight", "Тип пошлины фрахта", sidTypeDuty, typeDutyFreight, 1);
        ...
        quantityImporterStockTypeInvoice = addSGProp(baseGroup, "quantityImporterStockTypeInvoice", "Кол-во", quantityImporterStockArticle, 1, 2, typeInvoiceCategoryArticle, 3);
        ...
        netWeightImporterFreightUnitTypeInvoice = addSGProp(baseGroup, "netWeightImporterFreightUnitTypeInvoice", "Вес нетто", netWeightImporterFreightUnitArticle, 1, 2, typeInvoiceCategoryArticle, 3);
        ...
        netWeightImporterFreightTypeInvoice = addSGProp(baseGroup, "netWeightImporterFreightTypeInvoice", "Вес нетто", netWeightImporterFreightSku, 1, 2, typeInvoiceCategoryArticleSku, 3);
...
//        priceFreightImporterFreightSku = addJProp(baseGroup, "priceFreightImporterFreightSku", "Цена за фрахт", divideDouble2, sumFreightImporterFreightSku, 1, 2, 3, quantityImporterFreightSku, 1, 2, 3);
        ...
        dutyNetWeightFreightSku = addJProp(baseGroup, "dutyNetWeightFreightSku", "Пошлина по весу нетто", baseLM.multiplyDouble2, netWeightFreightSku, 1, 2, addJProp(dutySumCustomCategory10TypeDuty, customCategory10Sku, 2, typeDutyFreight, 1), 1, 2);
        ...
        dutyPercentImporterFreightSku = addJProp(baseGroup, "dutyPercentImporterFreightSku", "Пошлина по цене", baseLM.percent2, priceInOutImporterFreightSku, 1, 2, 3, addJProp(dutyPercentCustomCategory10TypeDuty, customCategory10Sku, 3, typeDutyFreight, 2), 1, 2, 3);

        dutyImporterFreightSku = addSUProp(baseGroup, "dutyImporterFreightSku", "Пошлина", Union.MAX, dutyNetWeightImporterFreightSku, dutyPercentImporterFreightSku);
        ...
        sumImporterFreightTypeInvoice = addSGProp(baseGroup, "sumImporterFreightTypeInvoice", "Сумма выходная", sumImporterFreightSku, 1, 2, typeInvoiceCategoryArticleSku, 3);
        ...
        sumInOutImporterFreightTypeInvoice = addSGProp(baseGroup, "sumInOutImporterFreightTypeInvoice", "Сумма выходная", sumInOutImporterFreightSku, 1, 2, typeInvoiceCategoryArticleSku, 3);
        ...
        quantityImporterFreightTypeInvoice = addSGProp(baseGroup, "quantityImporterFreightTypeInvoice", "Кол-во позиций", quantityProxyImporterFreightSku, 1, 2, typeInvoiceCategoryArticleSku, 3);
        ...
        grossWeightImporterFreightTypeInvoice = addSGProp(baseGroup, "grossWeightImporterFreightTypeInvoice", "Вес брутто", grossWeightImporterFreightSku, 1, 2, typeInvoiceCategoryArticleSku, 3);
        ...
        grossWeightImporterFreightUnitTypeInvoice = addSGProp(baseGroup, "grossWeightImporterFreightUnitTypeInvoice", "Вес брутто", grossWeightImporterFreightUnitArticle, 1, 2, typeInvoiceCategoryArticle, 3);
...
//            addActionsOnObjectChange(objBarcode, addPropertyObject(barcodeNotFoundMessage, objBarcode));
    ...
    private class CustomCategoryFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private CustomCategoryFormEntity(NavigatorElement parent, String sID, String caption, boolean tree) {
            ...
            objCustomCategory10 = addSingleGroupObject(customCategory10, "Четвёртый уровень", sidCustomCategory10, nameCustomCategory, countRelationCustomCategory10);
            ...
            objTypeDuty = addSingleGroupObject(typeDuty, "Тип таможенного платежа", sidTypeDuty);
    ...
    private class FreightChangeFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private FreightChangeFormEntity(NavigatorElement parent, String sID, String caption, boolean edit) {
            ...
            objFreight = addSingleGroupObject(freight, "Фрахт", baseLM.date, baseLM.objectClassName, nameRouteFreight, sidTypeDutyFreight, nameExporterFreight, nameFreightTypeFreight, grossWeightFreight, palletNumberFreight);
    ...
    private class FreightInvoiceFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private FreightInvoiceFormEntity(NavigatorElement parent, String sID, String caption, boolean edit) {
            ...
            objFreight = addSingleGroupObject(freight, "Фрахт", baseLM.date, baseLM.objectClassName, nameRouteFreight, sidTypeDutyFreight, nameFreightTypeFreight, nameCurrencyFreight, sumInFreight, sumMarkupInFreight, sumInOutFreight, palletNumberFreight);
    ...
    private class PrintDocumentFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private PrintDocumentFormEntity(NavigatorElement parent, String sID, String caption) {
            ...
            addFixedFilter(new NotNullFilterEntity(addPropertyObject(quantityImporterFreight, objImporter, objFreight)));
            addFixedFilter(new NotNullFilterEntity(addPropertyObject(quantityImporterFreightSku, objImporter, objFreight, objSku)));
            addFixedFilter(new CompareFilterEntity(addPropertyObject(typeInvoiceCategoryArticleSku, objSku), Compare.EQUALS, objTypeInvoice));
