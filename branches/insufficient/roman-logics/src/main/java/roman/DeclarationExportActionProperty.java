...
public class DeclarationExportActionProperty extends ActionProperty {
    ...
    private class DeclarationExporter {
        ...
        public void getPropertyDraws() throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
            ...
            FormInstance formInstance = new FormInstance(BL.invoiceFromFormEntity, BL, session, PolicyManager.serverSecurityPolicy, null, null, new DataObject(BL.getServerComputer(), BL.computer));
            ObjectInstance importerObj = formInstance.instanceFactory.getInstance(BL.invoiceFromFormEntity.objImporter);
            ObjectInstance freightObj = formInstance.instanceFactory.getInstance(BL.invoiceFromFormEntity.objFreight);
            ObjectInstance articleObj = formInstance.instanceFactory.getInstance(BL.invoiceFromFormEntity.objArticle);
            ObjectInstance compositionObj = formInstance.instanceFactory.getInstance(BL.invoiceFromFormEntity.objComposition);
            ObjectInstance countryObj = formInstance.instanceFactory.getInstance(BL.invoiceFromFormEntity.objCountry);
            ObjectInstance categoryObj = formInstance.instanceFactory.getInstance(BL.invoiceFromFormEntity.objCategory);

            map.put(G15Decl, formInstance.getPropertyDraw(BL.name, countryObj.groupTo));
            map.put(G33Decl, formInstance.getPropertyDraw(BL.sidCustomCategory10));
            map.put(G33Dobl, formInstance.getPropertyDraw(BL.sidCustomCategory10));
            map.put(G542Decl, formInstance.getPropertyDraw(BL.date, freightObj.groupTo));
            map.put(G542Dobl, formInstance.getPropertyDraw(BL.date, freightObj.groupTo));
            map.put(G082Decl, formInstance.getPropertyDraw(BL.name, importerObj.groupTo));
            map.put(G142Decl, formInstance.getPropertyDraw(BL.name, importerObj.groupTo));
            map.put(G092Decl, formInstance.getPropertyDraw(BL.name, importerObj.groupTo));
            map.put(G083Decl, formInstance.getPropertyDraw(BL.addressSubject));
            map.put(G143Decl, formInstance.getPropertyDraw(BL.addressSubject));
            map.put(G093Decl, formInstance.getPropertyDraw(BL.addressSubject));
            map.put(G142Dobl, formInstance.getPropertyDraw(BL.name, importerObj.groupTo));
            map.put(G143Dobl, formInstance.getPropertyDraw(BL.addressSubject));
            map.put(G312Decl, formInstance.getPropertyDraw(BL.sidArticle));
            map.put(G312Dobl, formInstance.getPropertyDraw(BL.sidArticle));
            map.put(G022IDecl, formInstance.getPropertyDraw(BL.nameExporterFreight));
            map.put(G023IDecl, formInstance.getPropertyDraw(BL.addressExporterFreight));
            map.put(G41Decl, formInstance.getPropertyDraw(BL.quantityImporterFreightArticleCompositionCountryCategory));
            map.put(G41Dobl, formInstance.getPropertyDraw(BL.quantityImporterFreightArticleCompositionCountryCategory));
            map.put(G315ADecl, formInstance.getPropertyDraw(BL.quantityImporterFreightArticleCompositionCountryCategory));
            map.put(G315ADobl, formInstance.getPropertyDraw(BL.quantityImporterFreightArticleCompositionCountryCategory));
            map.put(G315BDecl, formInstance.getPropertyDraw(BL.netWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G315BDobl, formInstance.getPropertyDraw(BL.netWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G38Decl, formInstance.getPropertyDraw(BL.netWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G38Dobl, formInstance.getPropertyDraw(BL.netWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G38ADecl, formInstance.getPropertyDraw(BL.netWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G38ADobl, formInstance.getPropertyDraw(BL.netWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G35Decl, formInstance.getPropertyDraw(BL.grossWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G35Dobl, formInstance.getPropertyDraw(BL.grossWeightImporterFreightArticleCompositionCountryCategory));
            map.put(G317ADecl, formInstance.getPropertyDraw(BL.nameUnitOfMeasureArticle));
            map.put(G317ADobl, formInstance.getPropertyDraw(BL.nameUnitOfMeasureArticle));
            map.put(G41BDecl, formInstance.getPropertyDraw(BL.nameUnitOfMeasureArticle));
            map.put(G41BDobl, formInstance.getPropertyDraw(BL.nameUnitOfMeasureArticle));

            map.put(G31_NTG313, formInstance.getPropertyDraw(BL.sidArticle));
            map.put(G31_FIRMAG313, formInstance.getPropertyDraw(BL.nameExporterFreight));
            map.put(G31_KTG313, formInstance.getPropertyDraw(BL.quantityImporterFreightArticleCompositionCountryCategory));
            map.put(G31_EIG313, formInstance.getPropertyDraw(BL.nameUnitOfMeasureArticle));
