...
public abstract class BusinessLogics<T extends BusinessLogics<T>> implements PropertyUpdateView {
    ...
    public BusinessLogics(int testType) throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
        initBase();
...
//        Seed = 6646;
    ...
    protected abstract void initNavigators();
    ...
    public DataSession createSession(DataAdapter adapter) throws SQLException {
