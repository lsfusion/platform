        ...
        try {
            ...
            if (dictionaryObject != null && termObject != null) {
                ...
                if (source != null) {
                    ...
                    String result = "";
                    String fullLineTranslation = (String) (getLCP(insensitive ? "insensitiveTranslationDictionaryEntryDictionaryTerm" : "translationDictionaryEntryDictionaryTerm").read(context, dictionaryObject, new DataObject(source, StringClass.text)));
                    if (fullLineTranslation != null) {
                        ...
                        while (st.hasMoreTokens()) {
                            ...
                            if (!delim.contains(token.subSequence(0, token.length()))) {
                                String translation = (String) (getLCP(insensitive ? "insensitiveTranslationDictionaryEntryDictionaryTerm" : "translationDictionaryEntryDictionaryTerm").read(context, dictionaryObject, new DataObject(token, StringClass.text)));
                                if (translation != null) {
