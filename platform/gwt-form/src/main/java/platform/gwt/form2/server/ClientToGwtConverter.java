...
public class ClientToGwtConverter extends ObjectConverter {
    ...
    @platform.gwt.form.server.Converter(from = RunPrintReportClientAction.class)
    public platform.gwt.view.actions.GRunPrintReportAction convertAction(RunPrintReportClientAction action, HttpSession session, FormSessionObject form) throws IOException {
        return new platform.gwt.view.actions.GRunPrintReportAction(generateReport(session, form, true));
    }

    @platform.gwt.form.server.Converter(from = RunOpenInExcelClientAction.class)
    public platform.gwt.view.actions.GRunOpenInExcelAction convertAction(RunOpenInExcelClientAction action, HttpSession session, FormSessionObject form) throws IOException {
        return new platform.gwt.view.actions.GRunOpenInExcelAction(generateReport(session, form, false));
    }
