...
public class GTreeTableTree extends Tree {
    private GForm form;
    ...
    public GTreeTableTree(GForm iForm) {
        ...
        setRoot(new GTreeTableNode());
    }

    @Override
    public GTreeTableNode getRoot() {
        return (GTreeTableNode) super.getRoot();
    }
    ...
    private class ExpandingTreeTableNode extends TreeNode {
