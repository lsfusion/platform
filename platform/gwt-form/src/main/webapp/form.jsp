...
<div id="loading">
    <div class="loadingIndicator">
        ...
        <img src="platform.gwt.form.Form/images/loading.gif" width="16" height="16" style="margin-right:8px;float:left;vertical-align:top;"/>Fusion forms 1.0<br/>
...
<script type="text/javascript" language="javascript" src="platform.gwt.form.Form/platform.gwt.form.Form.nocache.js"></script>
