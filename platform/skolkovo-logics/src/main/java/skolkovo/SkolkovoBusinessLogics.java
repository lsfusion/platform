...
//        quantityDocumentArticle.setDerivedChange(orderedInvoiceArticle, 1, 2, numberListArticle, 1, 2);
    ...
    private class OrderFormEntity extends FormEntity<SkolkovoBusinessLogics> {
    ...
    private class InvoiceFormEntity extends FormEntity<SkolkovoBusinessLogics> {
        private ObjectEntity objSupplier;
        private ObjectEntity objOrder;
    ...
    private class ShipmentFormEntity extends FormEntity<SkolkovoBusinessLogics> {
