...
//        Settings.instance.setEditActionOnSingleClick(true);
    ...
    public void initProperties0() {
        ...
        // monthInYeasterdayDate = addJProp("monthInYeasterdayDate", "Вчерашний месяц", baseLM.numberMonthInDate, addJProp(baseLM.addDate2, baseLM.currentDate, addCProp("1", IntegerClass.instance, 1)));
...
//        dateEndVote = addJProp(baseGroup, "dateEndVote", "Дата окончания", addDate2, dateStartVote, 1, requiredPeriod);
        ...
        dateEndVote.setDerivedValueForcedChange(aggrDateEndVote, 1, dateStartVote, 1);
...
//        generateVoteProject.setDerivedForcedChange(addCProp(ActionClass.instance, true), needExtraVoteProject, 1, autoGenerateProject, 1);
        ...
        baseLM.generateLoginPassword.setEventForcedAction(is(expert), 1);
...
//        dateProjectFormalControl = addJProp("dateProjectFormalControl", "Дата проекта", dateProject, projectFormalControl, 1);
        ...
        dateTimeSubmitFormalControl.setDerivedValueForcedChange(updateDateFormalControl, 1, is(formalControl), 1);
        ...
        dateTimeSubmitLegalCheck.setDerivedValueForcedChange(updateDateLegalCheck, 1, is(legalCheck), 1);
        ...
        projectActionLegalCheck.setDerivedValueChange(addJProp(projectActionProject, projectLegalCheck, 1), 1, is(legalCheck), 1);
...
//        LP currentDateFormalControlProject = maxFormalControlProjectProps[0];
        ...
        projectActionFormalControl.setDerivedValueChange(addJProp(projectActionProject, projectFormalControl, 1), 1, is(formalControl), 1);
...
//                negativeResultForesightCheckProject, 1, commentForesightCheckProject, 1), false);
        ...
        sentForTranslationProject.setDerivedValueForcedChange(addCProp(LogicalClass.instance, true), needTranslationProject, 1);
...
//        projectSucceededClaimer = addAGProp(idGroup, "projectSucceededClaimer", true, "Успешный проект (ИД)", acceptedProject, 1, claimerProject, 1);
        ...
        emailLetterExpertVote.setEventForcedAction(inNewExpertVote, 1, 2);
        ...
        emailClaimerVote.setEventForcedAction(openedVote, 1);
        ...
        emailFondVote.setEventForcedAction(openedVote, 1);
...
//        emailProtocolVote.setDerivedForcedChange(addCProp(ActionClass.instance, true), closedVote, 1);
        ...
        emailClosedVote.setEventForcedAction(closedVote, 1);
        ...
        emailForesightCheckProjectEA.setEventForcedAction(resultForesightCheckProject, 1);
        ...
        emailNotificationProject.setEventForcedAction(needForesightCheckProject, 1);
...
//        emailForesightClaimerProject.setDerivedForcedChange(addCProp(ActionClass.instance, true), negativeResultForesightCheckProject, 1);
        ...
        emailBureauTrProject.setEventForcedAction(sentForTranslationProject, 1);
...
//        emailNeedVoteProject = addJProp(baseGroup, true, "emailNeedVoteProject", "Письмо в фонд о необходимости заседания (e-mail)", emailNeedVoteProjectEA, 1, addCProp(StringClass.get(2000), "Созвать заседание!"));
        ...
        emailNeedVoteProject.setEventForcedAction(needVoteProject, 1);
        ...
        emailTransferredProject.setEventForcedAction(transferredProject, 1);
  ...
  //      emailClaimerFormalControl = addJProp(actionGroup, true, "emailClaimerFormalControl", "Письмо о формальной экспертизе", emailClaimerFormalControlEA, 1, emailClaimerHeaderFormalControl, 1);
        ...
        emailFondFormalControl.setEventForcedAction(resultFormalControl, 1);
...
//        addEARecipients(emailClaimerLegalCheckEA, MimeMessage.RecipientType.BCC, emailFinalClusterLegalCheck, 1);
        ...
        emailClaimerLegalCheckProject.setEventForcedAction(positiveResultForesightCheckProject, 1);
...
//        emailAuthExpert.setDerivedChange(addCProp(ActionClass.instance, true), baseLM.userLogin, 1, baseLM.userPassword, 1);
        ...
        emailAcceptedProject.setEventForcedAction(acceptedProject, 1);
        ...
        emailLetterCertificatesExpertMonthYear.setEventForcedAction(isNewMonth);
