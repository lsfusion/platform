...
@Component("jnlpHandler")
public class JNLPReqestHandler implements HttpRequestHandler {
    protected final static Logger logger = Logger.getLogger(JNLPReqestHandler.class);
