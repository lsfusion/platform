...
public class BudgetBusinessLogics extends BusinessLogics<BudgetBusinessLogics> {
    public BudgetBusinessLogics(DataAdapter adapter, int exportPort) throws IOException, ClassNotFoundException, SQLException, IllegalAccessException, InstantiationException, FileNotFoundException, JRException {
