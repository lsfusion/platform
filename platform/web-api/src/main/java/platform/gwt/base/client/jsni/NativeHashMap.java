...
public class NativeHashMap<K, V> implements Map<K, V> {
    ...
    public native V jsGet(Object key, int hashCode) /*-{
        var array = this.@platform.gwt.base.client.jsni.NativeHashMap::hasCodeMap[hashCode];
        if (array) {
            for (var i = 0, c = array.length; i < c; ++i) {
                var entry = array[i];
                if (this.@platform.gwt.base.client.jsni.NativeHashMap::equalsBridge(Ljava/lang/Object;Ljava/lang/Object;)(key, entry[0])) {
                    return entry[1];
                }
            }
        }
    ...
    private native V jsPut(K key, V value, int hashCode) /*-{
        ...
        if (array) {
            ...
            array = this.@platform.gwt.base.client.jsni.NativeHashMap::hasCodeMap[hashCode] = []
        }

        array.push([key, value]);
        ++this.@platform.gwt.base.client.jsni.NativeHashMap::size;
        return null;
    }-*/;
            ...
            for (var i = 0, c = array.length; i < c; ++i) {
                ...
                if (this.@platform.gwt.base.client.jsni.NativeHashMap::equalsBridge(Ljava/lang/Object;Ljava/lang/Object;)(key, entry[0])) {
                    if (array.length == 1) {
                        ...
                        delete this.@platform.gwt.base.client.jsni.NativeHashMap::hasCodeMap[hashCode];
                    } else {
                        array.splice(i, 1)
                    }
                    --this.@platform.gwt.base.client.jsni.NativeHashMap::size;
    ...
    private native boolean jsContainsKey(Object key, int hashCode) /*-{
        ...
        if (array) {
            for (var i = 0, c = array.length; i < c; ++i) {
                if (this.@platform.gwt.base.client.jsni.NativeHashMap::equalsBridge(Ljava/lang/Object;Ljava/lang/Object;)(key, array[i][0])) {
                    return true;
                }
            }
        }
    ...
    private native boolean jsContainsValue(Object value) /*-{
        var hashCodeMap = this.@platform.gwt.base.client.jsni.NativeHashMap::hasCodeMap;
        for (var hashCode in hashCodeMap) {
            ...
            if (hashCode == hashCodeInt) {
                ...
                for (var i = 0, c = array.length; i < c; ++i) {
                    if (this.@platform.gwt.base.client.jsni.NativeHashMap::equalsBridge(Ljava/lang/Object;Ljava/lang/Object;)(value, array[i][1])) {
                        return true;
                    }
                }
            }
    ...
    private native void jsForeachKey(Function f) /*-{
        ...
        for (var hashCode in hashCodeMap) {
            ...
            if (hashCode == hashCodeInt) {
                var array = hashCodeMap[hashCodeInt];
                for (var i = 0, c = array.length; i < c; ++i) {
                    this.@platform.gwt.base.client.jsni.NativeHashMap::bridgeApply(Lplatform/gwt/base/client/jsni/Function;Ljava/lang/Object;)(f, array[i][0]);
                }
            }
        }
    }-*/;
    ...
    private native void jsForeachValue(Function f) /*-{
        ...
        for (var hashCode in hashCodeMap) {
            ...
            if (hashCode == hashCodeInt) {
                var array = hashCodeMap[hashCodeInt];
                for (var i = 0, c = array.length; i < c; ++i) {
                    this.@platform.gwt.base.client.jsni.NativeHashMap::bridgeApply(Lplatform/gwt/base/client/jsni/Function;Ljava/lang/Object;)(f, array[i][1]);
                }
            }
        }
    }-*/;
    ...
    private native void jsForeachEntry(Function2 f) /*-{
        ...
        for (var hashCode in hashCodeMap) {
            ...
            if (hashCode == hashCodeInt) {
                var array = hashCodeMap[hashCodeInt];
                for (var i = 0, c = array.length; i < c; ++i) {
                    this.@platform.gwt.base.client.jsni.NativeHashMap::bridgeApply2(Lplatform/gwt/base/client/jsni/Function2;Ljava/lang/Object;Ljava/lang/Object;)
