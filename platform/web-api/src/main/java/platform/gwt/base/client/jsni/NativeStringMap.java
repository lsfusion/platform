...
public class NativeStringMap<K, V> implements Map<K, V> {
    ...
    public native V jsGet(String key) /*-{
        return this.@platform.gwt.base.client.jsni.NativeStringMap::valueMap[':' + key];
    }-*/;
    ...
    private native V jsPut(String sKey, K key, V value) /*-{
        ...
        var keyMap = this.@platform.gwt.base.client.jsni.NativeStringMap::keyMap;
        var valueMap = this.@platform.gwt.base.client.jsni.NativeStringMap::valueMap;
    ...
    public native int jsSize() /*-{
        var value = this.@platform.gwt.base.client.jsni.NativeStringMap::keyMap;
        var count = 0;
    ...
    private native boolean jsContainsValue(Object value, JavaScriptObject valueMap) /*-{
        for (var sKey in valueMap) {
            if (sKey.charCodeAt(0) == 58) {
                ...
                if (this.@platform.gwt.base.client.jsni.NativeStringMap::equalsBridge(Ljava/lang/Object;Ljava/lang/Object;)(value, entryValue)) {
                    return true;
                }
            }
        }
    ...
    private native void jsForeach(Function f, JavaScriptObject map) /*-{
        for (var sKey in map) {
            if (sKey.charCodeAt(0) == 58) {
                this.@platform.gwt.base.client.jsni.NativeStringMap::bridgeApply(Lplatform/gwt/base/client/jsni/Function;Ljava/lang/Object;)(f, map[sKey]);
            }
        }
    }-*/;
    ...
    private native void jsForeachEntry(Function2 f) /*-{
        ...
        for (var sKey in keyMap) {
            if (sKey.charCodeAt(0) == 58) {
                this.@platform.gwt.base.client.jsni.NativeStringMap::bridgeApply2(Lplatform/gwt/base/client/jsni/Function2;Ljava/lang/Object;Ljava/lang/Object;)
