...
import platform.gwt.cellview.client.HasData;

/**
 * Allows the previewing of events before they are fired to Cells.
 *
 * @param <T> the data type of the {@link platform.gwt.cellview.client.HasData} source
 */
public class CellPreviewEvent<T> extends GwtEvent<CellPreviewEvent.Handler<T>> {
     ...
     *
     * @param <T> the data type of the {@link platform.gwt.cellview.client.HasData}
     */
     ...
     * @param display the {@link platform.gwt.cellview.client.HasData} source of the event
     * @param context the Cell {@link platform.gwt.cellview.client.cell.Cell.Context}
    ...
    /**
     * Get the cell {@link platform.gwt.cellview.client.cell.Cell.Context}.
     *
     * @return the cell {@link platform.gwt.cellview.client.cell.Cell.Context}
     */
