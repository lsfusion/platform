...
class CellBasedWidgetImplTrident extends CellBasedWidgetImpl {
  ...
  private native void initFocusEventSystem() /*-{
    @platform.gwt.cellview.client.CellBasedWidgetImplTrident::dispatchFocusEvent = $entry(function() {
      @platform.gwt.cellview.client.CellBasedWidgetImplTrident::handleNonBubblingEvent(Lcom/google/gwt/user/client/Event;)($wnd.event);
    });
  }-*/;
  ...
  private native void sinkFocusEvents(Element elem) /*-{
    elem.attachEvent('onfocusin',
        @platform.gwt.cellview.client.CellBasedWidgetImplTrident::dispatchFocusEvent);
