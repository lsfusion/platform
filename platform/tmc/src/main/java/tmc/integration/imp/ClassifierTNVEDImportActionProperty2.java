...
public class ClassifierTNVEDImportActionProperty2 extends ActionProperty {
    private RomanBusinessLogics BL;
    private String importType;

    public ClassifierTNVEDImportActionProperty2(String sID, String caption, RomanBusinessLogics BL, String importType) {
