...
public class GObjectType extends GType {
    ...
    public FormItem createGridEditorItem(FormLogicsProvider formLogics, GPropertyDraw property) {
        throw new IllegalStateException("createGridEditorItem isn't supported for GObjectType");
    }
    ...
    public Object parseString(String strValue) {
        throw new IllegalStateException("parseString isn't supported for GObjectType");
    }
