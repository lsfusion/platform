...
public interface PropertyRendererComponent {
    Color SELECTED_CELL_BORDER_COLOR = new Color(175, 175, 255);
    Color SELECTED_CELL_BACKGROUND = new Color(249, 249, 255);
    Color FOCUSED_CELL_BORDER_COLOR = new Color(98, 98, 255);
    Color FOCUSED_CELL_BACKGROUND = new Color(232, 232, 255);
    Border SELECTED_CELL_BORDER = BorderFactory.createMatteBorder(1, 0, 1, 0, SELECTED_CELL_BORDER_COLOR);
