...
//        priceFreightImporterFreightSku = addJProp(baseGroup, "priceFreightImporterFreightSku", "Цена за фрахт", divideDouble2, sumFreightImporterFreightSku, 1, 2, 3, quantityImporterFreightSku, 1, 2, 3);
        ...
        sumInFreightArticle = addSGProp(baseGroup, "sumInFreightArticle", true, "Сумма входная", sumInOutImporterFreightSku, 2, articleSku, 3);
        sumInFreightBrandSupplier = addSGProp(baseGroup, "sumInFreightBrandSupplier", true, "Сумма входная", sumInOutImporterFreightSku, 2, brandSupplierArticleSku, 3);
    ...
    private class NomenclatureFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private NomenclatureFormEntity(NavigatorElement parent, String sID, String caption) {
            ...
            objSku = addSingleGroupObject(sku, "SKU", baseLM.selection, baseLM.barcode, nameSupplierArticleSku, nameBrandSupplierArticleSku, nameThemeSupplierArticleSku, sidSeasonSupplierArticleSku,
                    ...
                    sidColorSupplierItem, nameColorSupplierItem, sidSizeSupplierItem,
                    nameCountrySku, netWeightSku,
                    mainCompositionSku, additionalCompositionSku, quantitySku);
            addObjectActions(this, objSku);
