...
public class RomanLogicsModule extends LogicsModule {
    ...
    private LP customCategory10CategoryGenderComposition;
    private LP sidCustomCategory10CategoryGenderComposition;
    private LP customCategory10ArticleColor;
    private LP sidCustomCategory10ArticleColor;
    private LP customCategory10ArticleColorSku;
    ...
    private LP quantityImporterFreightArticleNetWeight;
    private LP quantityFreightArticleColor;
    ...
    public void initTables() {
        ...
        baseLM.tableFactory.include("importerFreightArticleWeight", importer, freight, article, DoubleClass.instance);
...
//        addConstraint(addJProp("Для товара должен быть задан артикул", baseLM.andNot1, is(sku), 1, articleSku, 1), false);
       ...
       /*addConstraint(addJProp("Выбранный должен быть среди связанных кодов", andNot1, addCProp(LogicalClass.instance, true, article), 1,
        ...
        /////invoicedOrderInvoiceSku = addJProp(baseLM.and1, quantityDocumentSku, 2, 3, inOrderInvoice, 1, 2);

        orderedInvoiceSku = addSGProp(baseGroup, "orderedInvoiceSku", "Кол-во заказано", orderedOrderInvoiceSku, 2, 3);
        //invoicedOrderSku = addSGProp(baseGroup, "orderedInvoiceSku", "Кол-во в инвойсах", invoicedOrderInvoiceSku, 1, 3);
...
//                routeToFillShipmentBarcode, 1, 2);
        ...
        quantityFreightArticleColor = addSGProp(baseGroup, "quantityFreightArticleColor", "Кол-во", quantityImporterFreightSku, 2, articleSku, 3, colorSupplierItem, 3);

        quantityImporterFreightArticleNetWeight = addSGProp(baseGroup, "quantityImporterFreightArticleNetWeight", true, true, "Кол-во", quantityImporterFreightSku, 1, 2, articleSku, 3, netWeightSku, 3);
...
//        priceFreightImporterFreightSku = addJProp(baseGroup, "priceFreightImporterFreightSku", "Цена за фрахт", divideDouble2, sumFreightImporterFreightSku, 1, 2, 3, quantityImporterFreightSku, 1, 2, 3);
        ...
        minPriceRateImporterFreightArticle = addMGProp(baseGroup, "minPriceRateImporterFreightArticle", "Минимальная для артикула за кг", minPriceRateImporterFreightSku, 1, 2, articleSku, 3);
        ...
        minPriceRateWeightImporterFreightArticle = addMGProp(baseGroup, "minPriceRateWeightImporterFreightArticle", "Минимальная для артикула", minPriceRateWeightImporterFreightSku, 1, 2, articleSku, 3);
        ...
        netWeightNegativeFreightArticle = addMGProp(baseGroup, "netWeightNegativeImporterFreightArticle", "Вес нетто", addJProp(baseLM.minusDouble, netWeightFreightSku, 1, 2), 1, articleSku, 2);
        ...
        diffPriceMinPriceImporterFreightArticle = addDUProp(baseGroup, "diffPriceMinPriceImporterFreightArticle", "Разница цен", minPriceRateImporterFreightArticle, priceOutKgImporterFreightArticle);
...
//            getPropertyDraw(dateImporterFreightTypeInvoice).toDraw = objSku.groupTo;
    ...
    private class FreightInvoiceFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private FreightInvoiceFormEntity(NavigatorElement parent, String sID, String caption) {
            ...
            addPropertyDraw(objImporter, objFreight, objArticle, quantityImporterFreightArticle, priceInImporterFreightArticle, markupPercentImporterFreightArticle, priceOutImporterFreightArticle, priceOutKgImporterFreightArticle, minPriceRateImporterFreightArticle);
            ...
            getPropertyDraw(priceOutKgImporterFreightArticle).setPropertyHighlight(greaterPriceMinPriceImporterFreightArticleProperty);
...
//            addHintsNoUpdate(NDSImporterFreightSku);
    ...
    private class FreightContentFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private FreightContentFormEntity(NavigatorElement<RomanBusinessLogics> parent, String sID, String caption) {
            ...
            addPropertyDraw(objFreight, objBrand, quantityShipmentedFreightBrandSupplier, quantityFreightBrandSupplier, sumInFreightBrandSupplier, sumInOutFreightBrandSupplier);
    ...
    private class FreightBoxContentFormEntity extends BarcodeFormEntity {
        ...
        private FreightBoxContentFormEntity(NavigatorElement<RomanBusinessLogics> parent, String sID, String caption) {
            ...
            objFreight = addSingleGroupObject(freight, "Фрахт", baseLM.date, dateArrivalFreight, nameExporterFreight);
