...
public class RomanLogicsModule extends LogicsModule {
    ...
    private LP itemArticleCompositeColorSize;
...
//        quantityListArticle.setDerivedForcedChange(orderedInvoiceArticle, 1, 2, numberListArticle, 1, 2);
        ...
        quantitySimpleInvoiceSimpleShipmentStockSku = addPGProp(baseGroup, "quantityDataSimpleInvoiceSimpleShipmentStockSku", true, 0, true, "Кол-во оприход.",
        ...
        //quantitySimpleInvoiceSimpleShipmentStockSku = addSUProp(baseGroup, "quantitySimpleInvoiceSimpleShipmentStockSku", "Кол-во оприход.", Union.SUM, quantitySimpleInvoiceSimpleShipmentStockItem, quantityDataSimpleInvoiceSimpleShipmentStockSku);
...
//        priceFreightImporterFreightSku = addJProp(baseGroup, "priceFreightImporterFreightSku", "Цена за фрахт", divideDouble2, sumFreightImporterFreightSku, 1, 2, 3, quantityImporterFreightSku, 1, 2, 3);
        ...
        sumImporterFreightTypeInvoice = addSGProp(baseGroup, "sumImporterFreightTypeInvoice", "Сумма выходная", sumProxyImporterFreightSku, 1, 2, typeInvoiceFreightArticleSku, 2, 3);
...
//            addObjectActions(this, objFreight);
    ...
    public class SbivkaFormEntity extends FormEntity<RomanBusinessLogics> {
        ...
        private SbivkaFormEntity(NavigatorElement parent, String sID, String caption) {
            ...
            objCategory = addSingleGroupObject(5, "category", category, "Номенклатурная группа", baseLM.name);
