...
class CellBasedWidgetImplStandard extends CellBasedWidgetImpl {
  ...
  private native void initEventSystem() /*-{
    @platform.gwt.cellview.client.CellBasedWidgetImplStandard::dispatchNonBubblingEvent = $entry(function(evt) {
      @platform.gwt.cellview.client.CellBasedWidgetImplStandard::handleNonBubblingEvent(Lcom/google/gwt/user/client/Event;)(evt);
    });
  }-*/;
  ...
  private native void sinkEventImpl(Element elem, String typeName) /*-{
    elem.addEventListener(typeName, @platform.gwt.cellview.client.CellBasedWidgetImplStandard::dispatchNonBubblingEvent, true);
  }-*/;
}
