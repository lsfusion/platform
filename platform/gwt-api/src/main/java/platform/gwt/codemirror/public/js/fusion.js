CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ADD ADDFORM ADDOBJ ADDSESSIONFORM AFTER " + 
                           ...
                           "CONSTRAINT CUSTOM DATA DEFAULT DESC DESIGN DIALOG DO DOCKING " + 
                           "DRAWROOT ECHO EDIT EDITABLE EDITFORM EDITKEY EDITSESSIONFORM " + 
                           "ELSE END EXCEPTLAST EXCLUSIVE EXEC FALSE FILTER FILTERGROUP " + 
                           ...
                           "RESOLVE RIGHT RIGHTBOTTOM SELECTION SESSION SET SHORTCUT " + 
                           "SHOW SHOWIF STATIC SUM TABLE TEXTHALIGN TEXTVALIGN THE " + 
                           "THEN TO TODRAW TOOLBAR TOP TREE TRUE UNION UNIQUE UPDATE " + 
                           "VALIGN VERTICAL WHEN WHERE WHILE WINDOW XOR");
