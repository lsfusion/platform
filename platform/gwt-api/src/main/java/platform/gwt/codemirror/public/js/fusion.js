CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ADD ADDFORM ADDOBJ ADDSESSIONFORM AFTER " + 
                           ...
                           "DESC DESIGN DIALOG DO DOCKING DOCX DRAWROOT DRAWTOTOOLBAR " + 
                           "DROP ECHO EDIT EDITABLE EDITFORM EDITKEY EDITSESSIONFORM " + 
                           "ELSE EMAIL END EQUAL EVENTID EVENTS EXCELFILE EXCEPTLAST " + 
                           "EXCLUSIVE EXEC EXTEND FALSE FILTER FILTERGROUP FILTERS " + 
                           "FIXED FIXEDCHARWIDTH FOOTER FOR FORCE FOREGROUND FORM " + 
                           "FORMULA FROM FULLSCREEN GRID GROUP HALIGN HEADER HIDE " + 
                           "HIDESCROLLBARS HIDETITLE HINTNOUPDATE HINTTABLE HORIZONTAL " + 
                           ...
                           "OBJVALUE OK ON OPENFILE OR ORDER OVERRIDE PAGESIZE PANEL " + 
                           ...
                           "REQUIRE RESOLVE RETURN RGB RIGHT RIGHTBOTTOM ROUND RTF SEEK " +
