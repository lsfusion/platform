CodeMirror.defineMode("fusion", function(config, parserConfig) {
    ...
    var keywords = words("ABSTRACT ACTION ADD ADDFORM ADDOBJ ADDSESSIONFORM AFTER " + 
                           ...
                           "CHECKED CLASS COLUMNS CONCAT CONFIRM CONSTRAINT CUSTOM CUSTOM_FILE " +
                           "CYCLES DATA DEFAULT DESC DESIGN DIALOG DO DOCKING DOCX " + 
                           "DRAWROOT ECHO EDIT EDITABLE EDITFORM EDITKEY EDITSESSIONFORM " + 
                           "ELSE EMAIL END EQUAL EXCEL_FILE EXCEPTLAST EXCLUSIVE EXEC FALSE FILTER " +
                           ...
                           "HTML IF IMAGE IMAGE_FILE IMPORT IMPOSSIBLE IN INCREMENT INDEX INDEXED " +
                           ...
                           "PARENT PARTITION PDF PDF_FILE PERSISTENT POSITION PREFCHARWIDTH " +
                           ...
                           "WHERE WHILE WINDOW WORD_FILE XOR");
