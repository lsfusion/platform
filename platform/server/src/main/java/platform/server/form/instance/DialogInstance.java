...
public class DialogInstance<T extends BusinessLogics<T>> extends FormInstance<T> {
    ...
    public DialogInstance(FormEntity<T> entity,
        ...
        super(entity, BL, session, securityPolicy, tFocusView, classListener, computer, Collections.singletonMap(dialogEntity, session.getObjectValue(dialogValue, ObjectType.instance)));
