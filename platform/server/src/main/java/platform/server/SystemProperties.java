...
public class SystemProperties {
    ...
    public static final boolean isDebug = "true".equals(System.getProperty("platform.server.isdebug"));

    public static final String settingsPath = System.getProperty("platform.server.settingsPath", "conf/settings.xml");

    public static final boolean doNotCalculateStats = "true".equals(System.getProperty("platform.server.logics.donotcalculatestats"));
