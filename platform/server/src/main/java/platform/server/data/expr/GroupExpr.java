...
@Immutable
public abstract class GroupExpr<E extends Expr,This extends GroupExpr<E,This>> extends MapExpr implements MapContext {
    ...
    protected abstract Expr createThis(Where iWhere,Map<AndExpr,AndExpr> iGroup,E iExpr);
    ...
    private static Context getContext(Expr expr, Map<AndExpr, AndExpr> group, Where where) {
...
//        return this;
    ...
    static <K,V> Collection<InnerJoins.Entry> getInnerJoins(Map<K,AndExpr> groupKeys, Expr expr,Where where) {
