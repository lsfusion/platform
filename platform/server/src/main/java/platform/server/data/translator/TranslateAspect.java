...
public class TranslateAspect {
    ...
    @Around("call(* *.translate(platform.server.data.translator.MapTranslate)) && target(toTranslate)  && args(translator)")
    public Object callTranslateSourceJoin(ProceedingJoinPoint thisJoinPoint, SourceJoin toTranslate, MapValuesTranslate translator) throws Throwable {
