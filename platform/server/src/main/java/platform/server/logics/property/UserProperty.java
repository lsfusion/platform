...
public abstract class UserProperty extends Property<ClassPropertyInterface> {
    ...
    protected abstract AndClassSet getValueSet();
    ...
    protected ClassWhere<Field> getClassWhere(PropertyField storedField) {
        ...
        result.put(storedField, getValueSet());
    ...
    public abstract void execute(Map<ClassPropertyInterface, DataObject> keys, ObjectValue value, DataSession session, List<ClientAction> actions, RemoteFormView executeForm) throws SQLException;
}
