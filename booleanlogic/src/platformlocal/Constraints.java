...
abstract class ValueConstraint extends Constraint {
    ...
    String Check(DataSession Session, Property Property) throws SQLException {
        ...
        Changed.add(CompareWhere.get(ValueExpr,Property.ChangeTable.Value.Type.getEmptyValueExpr(),Invalid));
...
class UniqueConstraint extends Constraint {
    ...
    String Check(DataSession Session, Property Property) throws SQLException {
        ...
        Map<PropertyInterface,KeyExpr> MapChange = new HashMap();
        Map<PropertyInterface,KeyExpr> MapPrev = new HashMap();
        for(PropertyInterface Interface : (Collection<PropertyInterface>)Property.Interfaces) {
        ...
        // равны значения
        Changed.add(CompareWhere.get(PrevExpr,ChangedExpr,CompareWhere.EQUALS));
        // значения не NULL
        Changed.add(ChangedExpr.getWhere());
