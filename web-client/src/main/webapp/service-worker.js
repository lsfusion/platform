...
self.addEventListener('push', function(event) {
    ...
    if(data.notify === true)
        ...
        dispatchAction(event, { action: data.action, result: null }, data.push, (client) => data.notify === false ? showFocusNotification(client) : {}, (actionResult, push) => showPushNotification(actionResult.action, push));
})
