    ...
    */
    PivotData = class PivotData {
      ...
      processRecord(record) { //this code is called in a tight loop
        ...
        flatRowKey = (this.callbacks ? this.callbacks.formatArray(this.rowAttrs, rowKey) : rowKey).join(String.fromCharCode(0));
        flatColKey = (this.callbacks ? this.callbacks.formatArray(this.colAttrs, colKey) : colKey).join(String.fromCharCode(0));
        ...
        resizeObserverUnused = new ResizeObserver(function() {
          ...
          if (childRect.width > 0) {
            ...
            if (minWidth === "" || minWidth === "0px") {
              return unusedDiv.css("min-width", `${childRect.width}px`);
            }
          }
        });
