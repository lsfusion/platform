(function() {
    ...
    callWithJQuery(function($, Plotly) {
        ...
        return $.pivotUtilities.plotly_renderers = {
            "Bar Chart": makePlotlyChart(true, {
                type: 'bar'
            }, {
                barmode: 'group'
            }, false),
            "Stacked Bar Chart": makePlotlyChart(true, {
                type: 'bar'
            }, {
                barmode: 'relative'
            }, false),
            "Line Chart": makePlotlyChart(true, {}, {}, false),
            "Area Chart": makePlotlyChart(true, {
                stackgroup: 1
            }, {}, false),
            "Scatter Chart": makePlotlyScatterChart(),
            'Multiple Pie Chart': makePlotlyChart(false, {
                type: 'pie',
                scalegroup: 1,
                hoverinfo: 'label+value',
                textinfo: 'none'
            }, {}, false),
            "Horizontal Bar Chart": makePlotlyChart(true, {
                type: 'bar',
                orientation: 'h'
            }, {
                barmode: 'group'
            }, true),
            "Horizontal Stacked Bar Chart": makePlotlyChart(true, {
                type: 'bar',
                orientation: 'h'
            }, {
                barmode: 'relative'
