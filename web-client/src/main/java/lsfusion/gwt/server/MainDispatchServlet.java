...
public class MainDispatchServlet extends net.customware.gwt.dispatch.server.standard.AbstractStandardDispatchServlet implements org.springframework.web.HttpRequestHandler, org.springframework.beans.factory.InitializingBean, org.springframework.beans.factory.BeanNameAware {
    ...
    protected void addHandlers(InstanceActionHandlerRegistry registry) {
        ...
        registry.addHandler(new ControllerExecActionHandler(this));
        registry.addHandler(new ControllerEvalActionHandler(this));
        registry.addHandler(new ControllerChangeActionHandler(this));
        ...
        registry.addHandler(new TreeGroupReportHandler(this));
        ...
        registry.addHandler(new ChangePropertyActiveHandler(this));
        registry.addHandler(new SelectAllHandler(this));
        registry.addHandler(new SetUserHiddenHandler(this));
    ...
    public static DispatchException fromWebServerToWebClient(Throwable e) {
        ...
        if(e instanceof AuthenticationException)
            ...
            RemoteInternalDispatchException clientInternalException = new RemoteInternalDispatchException(ExceptionUtils.copyMessage(e), RemoteInternalException.getLsfStack(e), RemoteInternalException.getAsyncStacks(e));
