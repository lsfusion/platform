...
public class FileUtils {
    ...
    public static ImageHolder createImage(ServletContext servletContext, String logicsName, SerializableImageIconHolder imageHolder, String imagesFolderName, boolean canBeDisabled) {
        if (imageHolder != null) {
