...
import lsfusion.gwt.server.form.LookupLogicsAndCreateNavigatorHandler;
import lsfusion.gwt.server.form.form.handlers.*;
import lsfusion.gwt.server.form.form.spring.FormProvider;
import lsfusion.gwt.server.form.logics.handlers.GenerateIDHandler;
import lsfusion.gwt.server.form.logics.spring.LogicsHandlerProvider;
import lsfusion.gwt.server.form.navigator.handlers.*;
