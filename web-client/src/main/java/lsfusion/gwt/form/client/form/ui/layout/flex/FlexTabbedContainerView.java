...
public class FlexTabbedContainerView extends TabbedContainerView {
    ...
    protected static class Panel extends FixFlexBasisComposite implements TabbedDelegate, IndexedPanel, HasBeforeSelectionHandlers<Integer>, HasSelectionHandlers<Integer>, RequiresResize, ProvidesResize {
        ...
        public Panel() {
            ...
            tabBar.addSelectionHandler(new SelectionHandler<Integer>() {
                ...
                public void onSelection(SelectionEvent<Integer> event) {
                    FlexTabbedContainerView.Panel.this.onTabSelected(event);
                }
            });
