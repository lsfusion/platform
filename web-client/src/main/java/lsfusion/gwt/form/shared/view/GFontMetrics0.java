...
//    private static final String DEFAULT_FONT_FAMILY = "Arial";
    ...
    public static final GFont DEFAULT_FONT = new GFont(DEFAULT_FONT_FAMILY, DEFAULT_FONT_PIXEL_SIZE, false, false);
    ...
    private static native void getFontMetrics(GFont gfont, String fontFamily, int fontSize, boolean bold, MetricsCallback callback) /*-{
        ...
        font.onload = function() {
            ...
            @lsfusion.gwt.form.shared.view.GFontMetrics0::setFontMetrics(Llsfusion/gwt/form/shared/view/GFont;DDLlsfusion/gwt/form/shared/view/GFontMetrics0$MetricsCallback;)(gfont, fontMeasure.width, fontMeasure.leading, callback);
        }

        font.onerror = function(errorMessage) {
            @lsfusion.gwt.form.shared.view.GFontMetrics0::errorLoadingFont(Llsfusion/gwt/form/shared/view/GFont;Llsfusion/gwt/form/shared/view/GFontMetrics0$MetricsCallback;)(gfont, callback);
        }
    }-*/;
