...
public interface FormSessionManager {
    GForm createForm(String canonicalName, String formSID, RemoteFormInterface remoteForm, Object[] immutableMethods, byte[] firstChanges, String tabSID, LogicsAwareDispatchServlet<RemoteLogicsInterface> servlet) throws IOException;
