...
//        element.getStyle().clearProperty("boxSizing");
    ...
    public static native JsDate createJsDate(double milliseconds)/*-{
        return $wnd.createPlainDate(milliseconds);
    }-*/;
