...
class CellBasedWidgetImplTrident extends CellBasedWidgetImpl {
   ...
   */
  private static void dispatchCellEvent(Widget widget, Element target, int eventBits, Event event) {
  ...
  private native void initFocusEventSystem() /*-{
    @lsfusion.gwt.client.base.view.grid.CellBasedWidgetImplTrident::dispatchFocusEvent = $entry(function() {
      @lsfusion.gwt.client.base.view.grid.CellBasedWidgetImplTrident::handleNonBubblingEvent(Lcom/google/gwt/user/client/Event;)($wnd.event);
    });
  }-*/;
  ...
  private native void sinkFocusEvents(Element elem) /*-{
    elem.attachEvent('onfocusin',
        @lsfusion.gwt.client.base.view.grid.CellBasedWidgetImplTrident::dispatchFocusEvent);
