...
class CellBasedWidgetImplStandard extends CellBasedWidgetImpl {
  ...
  private native void initEventSystem() /*-{
    @lsfusion.gwt.client.base.view.grid.CellBasedWidgetImplStandard::dispatchNonBubblingEvent = $entry(function(evt) {
      @lsfusion.gwt.client.base.view.grid.CellBasedWidgetImplStandard::handleNonBubblingEvent(Lcom/google/gwt/user/client/Event;)(evt);
    });
  }-*/;
  ...
  private native void sinkEventImpl(Element elem, String typeName) /*-{
    elem.addEventListener(typeName, @lsfusion.gwt.client.base.view.grid.CellBasedWidgetImplStandard::dispatchNonBubblingEvent, true);
  }-*/;
}
