...
// how an attribute reader's value is converted for the projection — declared by the reader
// (getAttributeConverter) and converted polymorphically here. Returns the JS value to store: a String, Boolean or plain JS object.
public enum GAttributeConverter {
