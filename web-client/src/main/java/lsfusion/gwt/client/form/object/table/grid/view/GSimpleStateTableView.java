...
public abstract class GSimpleStateTableView extends GStateTableView {
    ...
    protected void changeSimpleGroupObject(JavaScriptObject object, boolean dataUpdated) {
        changeGroupObject(toObject(object), dataUpdated);
    }
    ...
    protected native JavaScriptObject getController()/*-{
        ...
        return {
            ...
            changeSimpleGroupObject: function (object, dataUpdated) {
                var jsObject = thisObj.@GSimpleStateTableView::fromObject(*)(thisObj.@GSimpleStateTableView::getKey(*)(object));
                return thisObj.@GSimpleStateTableView::changeSimpleGroupObject(*)(jsObject, dataUpdated);
            }
        };
    }-*/;
}
