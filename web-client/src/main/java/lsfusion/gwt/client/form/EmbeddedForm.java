...
//        autoSize = editContext.getProperty().autoSize;
    ...
    protected void setContent(Widget widget) {
        widget.getElement().setTabIndex(-1); // we need to make form focusable, because otherwise clicking on this form will lead to moving focus to the grid (not the cell), which will cause blur and stop editing
