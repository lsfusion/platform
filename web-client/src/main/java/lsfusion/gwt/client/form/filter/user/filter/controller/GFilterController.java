package lsfusion.gwt.client.form.filter.user.filter.controller;
...
import lsfusion.gwt.client.form.filter.user.filter.GFilterDialogHeader;
import lsfusion.gwt.client.form.filter.user.filter.GFilterView;
