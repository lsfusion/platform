...
public class MenuBar extends Widget implements PopupListener, HasAnimation,
   ...
   */
  //todo: removed usage of Resources
  public MenuBar(boolean vertical) {
    this(vertical, /*GWT.<Resources> create(Resources.class)*/ (Resources) null);
  }
  ...
  public MenuBar(boolean vertical, Resources resources) {
    init(vertical,
        /*AbstractImagePrototype.create(resources.menuBarSubMenuIcon())*/ null);
  }
