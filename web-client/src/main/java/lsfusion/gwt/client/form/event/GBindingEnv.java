...
public class GBindingEnv implements Serializable {
    ...
    public static final GBindingEnv AUTO = new GBindingEnv(null, null, null, null, null);

    public GBindingEnv() {
    }

    public GBindingEnv(Integer priority, GBindingMode bindDialog, GBindingMode bindGroup, GBindingMode bindEditing, GBindingMode bindShowing) {
