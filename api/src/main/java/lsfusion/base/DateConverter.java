...
//        simpleDateFormat.set2DigitYearStart(new Date(45, 1, 1));
    ...
    static {
        ...
        DATETIME_FORMAT_REGEXPS.put("^\\d{4}-\\d{1,2}-\\d{1,2}\\s\\d{1,2}:\\d{2}:\\d{2}.\\d{3,4}$", "yyyy-MM-dd H:mm:ss.SSSS");
        ...
        DATETIME_FORMAT_REGEXPS.put("^\\d{4}-\\d{1,2}-\\d{1,2}t\\d{1,2}:\\d{2}:\\d{2}\\.\\d{3,4}$", "yyyy-MM-dd'T'H:mm:ss.SSSS");
    }
