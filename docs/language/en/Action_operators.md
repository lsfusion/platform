---
slug: "/Action_operators"
title: 'Action operators'
---

*Action operator* is a syntax construct that describes an [operator](../paradigm/Action_operators_paradigm.md) creating an [action](../paradigm/Actions.md).
...
Context dependent action operators can use external context parameters. They can be used wherever you need to define an action, for example, when creating another action or [event](../paradigm/Events.md). These operators are:
...
-   [`FILTER`, `FILTERS` operators](FILTER_ORDER_operators.md)
-   [`FILTERGROUP`, `FILTERGROUPS` operators](FILTER_ORDER_operators.md)
-   [`FILTER PROPERTY`, `FILTERS PROPERTY` operators](FILTER_ORDER_operators.md)
...
-   [`ORDER`, `ORDERS` operators](FILTER_ORDER_operators.md)
-   [`PRINT` operator](PRINT_operator.md)
-   [`READ` operator](READ_operator.md)
-   [`RECALCULATE` operator](RECALCULATE_operator.md)
