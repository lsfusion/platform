...
The `EXTERNAL` operator creates an [action](../paradigm/Actions.md) that implements [accessing to an external system](../paradigm/Access_to_an_external_system_EXTERNAL.md). 
...
- `lsfExecType`
    ...
    Keyword. Specifies the [way of defining](../paradigm/Access_from_an_external_system.md#actiontype) the action:
