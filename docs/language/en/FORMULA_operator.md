---
slug: "/FORMULA_operator"
title: 'FORMULA operator'
---

The `FORMULA` operator creates a [property](../paradigm/Properties.md) that implements a [custom formula](../paradigm/Custom_formula_FORMULA.md).
...
- `className`
    ...
    The name of the [builtin class](../paradigm/Built-in_classes.md) of the value returned by the property. If not specified, the resulting class is considered to be the [common ancestor](../paradigm/Built-in_classes.md#commonparentclass) of all property operands. Required for table-valued formulas (see the parameter list below): the value column of the returned table needs an explicit type.
