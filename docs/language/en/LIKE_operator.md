...
The `LIKE` operator creates a [property](../paradigm/Properties.md) that implements [string comparison with a pattern](../paradigm/Comparison_operators_=_etc.md). For full-text search, use the separate [`MATCH` operator](MATCH_operator.md).
...
- `searchExpr`
    ...
    The value of the expression must belong to one of the [string classes](../paradigm/Built-in_classes.md).
