...
The signature matching operator creates a [property](../paradigm/Properties.md) that determines, from a class perspective, whether the property specified in the operator can have a non-`NULL` value for the given arguments. In fact, this operator infers the possible classes of a given property from its semantics, and then, using [logical](../paradigm/Logical_operators_AND_OR_NOT_XOR.md) operators and the [classification](../paradigm/Classification_IS_AS.md) operator, creates the required property.
