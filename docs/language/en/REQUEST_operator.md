---
slug: "/REQUEST_operator"
title: 'REQUEST operator'
---

The `REQUEST` operator creates an [action](../paradigm/Actions.md) that [requests a value](../paradigm/Value_request_REQUEST.md).
...
- `elseAction`
    ...
    A context-dependent action operator that is executed if the input was [cancelled](../paradigm/Value_input.md#result).
