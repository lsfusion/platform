...
The `MATCH` operator creates a [property](../paradigm/Properties.md) that implements [full-text search](../paradigm/Comparison_operators_=_etc.md). For pattern matching, use the separate [`LIKE` operator](LIKE_operator.md).
