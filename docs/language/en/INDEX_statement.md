---
slug: "/INDEX_statement"
title: 'INDEX statement'
---

The `INDEX` statement creates a new [index](../paradigm/Indexes.md).
...
Here `field1, ..., fieldN` is a non-empty list of fields. Each element of this list can be written either as a [property](../paradigm/Properties.md) stored in this table:
