...
Pivot table settings block of the [`FORM` statement](FORM_statement.md) manages the initial settings of the [*pivot table* view type](../paradigm/Interactive_view.md#property) in the interactive view of the form.
