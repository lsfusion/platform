...
The `META` statement creates a new [metacode](../paradigm/Metaprogramming.md#metacode).
...
The `META` statement declares a new metacode and adds it to the current [module](../paradigm/Modules.md). 
...
- `statement1 ... statementM`
    ...
    A sequence of  [statements](Statements.md) represented by a block of code. Statements may contain [special operators `##` and `###`](../paradigm/Metaprogramming.md#concat) used for concatenating [lexemes](Tokens.md). Statements cannot include another `META` statement.
