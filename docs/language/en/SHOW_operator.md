...
The `SHOW` operator creates an [action](../paradigm/Actions.md) that [opens a form](../paradigm/In_an_interactive_view_SHOW_DIALOG.md) in interactive view. 
...
The `SHOW` operator creates an action that opens the specified form. When opening the form in the `OBJECTS` block, [initial values](../paradigm/Open_form.md#params) can be specified for [Form structure](../paradigm/Form_structure.md) form objects.
...
- `syncType`
    ...
    Determines in which [flow control](../paradigm/In_an_interactive_view_SHOW_DIALOG.md#flow) mode the operator will work:
