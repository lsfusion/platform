...
The `READ` operator creates an [action](../paradigm/Actions.md) that [reads a file](../paradigm/Read_file_READ.md) to a [property](../paradigm/Properties.md) from an external resource.
