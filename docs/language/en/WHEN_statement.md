...
The `WHEN` statement adds a [simple event](../paradigm/Simple_event.md) handler.
...
but it also has [a number of advantages](../paradigm/Simple_event.md).
:::
...
- `eventClause`
    ...
    [Event description block](Event_description_block.md). Describes the [base event](../paradigm/Events.md) for the created handler.
