...
The `=` statement creates a new [property](../paradigm/Properties.md).
...
The `=` statement declares a new property and adds it to the current [module](../paradigm/Modules.md).
