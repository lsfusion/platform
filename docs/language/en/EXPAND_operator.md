...
The `EXPAND` operator creates an [action](../paradigm/Actions.md) that expands either [elements](../paradigm/Object_tree_visibility_EXPAND_COLLAPSE.md) of an [object tree](../paradigm/Interactive_view.md#tree) on a form, or a collapsible [container](../paradigm/Form_design.md#containers) of a form.
