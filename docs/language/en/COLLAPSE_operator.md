...
The `COLLAPSE` operator is the creation of an [action](../paradigm/Actions.md), that implements the [collapse of elements](../paradigm/Object_tree_visibility_EXPAND_COLLAPSE.md) in the [object tree](../paradigm/Interactive_view.md#tree).
