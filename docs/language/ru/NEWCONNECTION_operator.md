...
Оператор `NEWCONNECTION` создаёт [действие](../paradigm/Actions.md), которое выполняет другое действие с сохранением [внешних подключений](../paradigm/New_connection_NEWCONNECTION.md) (`SQL`, `TCP`, `DBF`) между вызовами [`EXTERNAL`](EXTERNAL_operator.md).
