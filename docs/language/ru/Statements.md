...
Код любого [модуля](../paradigm/Modules.md) на **[lsFusion](Language.md)** состоит из последовательности *инструкций*.
...
-   [Инструкция `+=`](plus_equals_statement.md) 
-   [Инструкция `ACTION+`](ACTION_plus_statement.md)
