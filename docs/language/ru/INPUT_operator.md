...
Оператор `INPUT` создаёт [действие](../paradigm/Actions.md), осуществляющее [ввод примитива](../paradigm/Primitive_input_INPUT.md).
...
- `elseActionOperator`
    ...
    [Контекстно-зависимый оператор-действие](Action_operators.md#contextdependent), выполняется, если ввод был отменен. В качестве параметров нельзя использовать параметр результата ввода.
