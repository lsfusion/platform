...
Инструкция `INDEX` создает новый [индекс](../paradigm/Indexes.md).
...
Здесь `field1, ..., fieldN` - непустой список полей. Каждый его элемент может быть записан либо как [свойство](../paradigm/Properties.md), хранящееся в этой таблице:
