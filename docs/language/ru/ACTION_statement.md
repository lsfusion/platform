...
Инструкция `ACTION` - создание нового [действия](../paradigm/Actions.md).
...
Инструкция `ACTION` объявляет новое действие и добавляет его в текущий [модуль](../paradigm/Modules.md).
