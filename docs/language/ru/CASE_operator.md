...
Оператор `CASE` - создание [свойства](../paradigm/Properties.md), осуществляющего [выбор](../paradigm/Selection_CASE_IF_MULTI_OVERRIDE_EXCLUSIVE.md) результата по условию.
