...
Оператор `JSON` - свойство, создающее из [заданных свойств](../paradigm/Data_export_EXPORT.md) или, в общем случае, [из формы](../paradigm/In_a_structured_view_EXPORT_IMPORT.md) JSON 
