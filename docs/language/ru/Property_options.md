...
- `AUTOSET`
    ...
    Ключевое слово, помечающее [первичное свойство](../paradigm/Data_properties_DATA.md) с объектным параметром и объектным значением для автоматической установки при создании объекта. Если объект создается с опцией `AUTOSET` (например, `NEW ... AUTOSET`) и его класс совпадает с классом параметра свойства или является его наследником, платформа устанавливает для него это свойство в текущий объект класса значения, если он доступен.
