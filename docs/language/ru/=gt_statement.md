...
Инструкция `=>` - создание [следствия](../paradigm/Simple_constraints.md).
...
При создании следствия будет создано [ограничение](../paradigm/Constraints.md), которое во многом будет эквивалентно следующей инструкции
