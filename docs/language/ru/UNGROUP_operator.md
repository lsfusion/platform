...
Оператор `UNGROUP` - создание [свойства](../paradigm/Properties.md), реализующее [распределение](../paradigm/Distribution_UNGROUP.md) в расширенной форме.
