...
*Оператор-действие* - это синтаксическая конструкция, описывающая [оператор](../paradigm/Action_operators_paradigm.md), создающий [действие](../paradigm/Actions.md).
...
Контекстно-зависимые операторы-действия могут использовать параметры из внешнего контекста. Они могут быть использованы везде, где необходимо описать действие, например, при создании другого действия либо [события](../paradigm/Events.md). Такими операторами являются:
...
-   [Оператор `CLOSE FORM`](CLOSE_FORM_operator.md)
...
-   [Операторы `FILTER`, `FILTERS`](FILTER_ORDER_operators.md)
-   [Операторы `FILTERGROUP`, `FILTERGROUPS`](FILTER_ORDER_operators.md)
-   [Операторы `FILTER PROPERTY`, `FILTERS PROPERTY`](FILTER_ORDER_operators.md)
...
-   [Операторы `ORDER`, `ORDERS`](FILTER_ORDER_operators.md)
