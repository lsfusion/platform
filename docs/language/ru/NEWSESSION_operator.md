...
- `NESTED`
    ...
    Опциональное ключевое слово, после которого можно указать, какие [локальные свойства](../paradigm/Data_properties_DATA.md#local) текущей сессии переносятся в новую. Само по себе, без `LOCAL` и без списка свойств, на поведение оператора не влияет.
