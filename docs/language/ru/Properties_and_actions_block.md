...
- `insertPosition`
    ...
    - `BEFORE formPropertyName`
        ...
        Свойство или действие будет добавлено в структуру формы непосредственно перед (ключевое слово `BEFORE`) или после (ключевое слово `AFTER`) указанного свойства или действия.
