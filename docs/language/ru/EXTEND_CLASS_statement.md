...
- `objectName1, ..., objectNameM`
    ...
    Имена новых статических объектов указанного класса. Каждое имя задается [простым идентификатором](IDs.md#id). Свойство `name[StaticObject]` возвращает это имя вместе с пространством имён и классом — [каноническое имя](../paradigm/Static_objects.md) объекта.
