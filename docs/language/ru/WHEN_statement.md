...
Инструкция `WHEN` - добавление обработчика [простого события](../paradigm/Simple_event.md).
...
- `eventClause`
    ...
    [Блок описания события](Event_description_block.md). Описывает [базовое событие](../paradigm/Events.md) для создаваемого обработчика.
