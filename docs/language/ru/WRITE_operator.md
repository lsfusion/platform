...
Оператор `WRITE` - создание [действия](../paradigm/Actions.md), [записывающего файл](../paradigm/Write_file_WRITE.md) из свойства во внешний ресурс. 
...
- `APPEND`
    ...
    При использовании `CLIENT` объединение с существующим файлом `xls`, `xlsx`, `docx` или `pdf` выполняет только десктоп-клиент.
