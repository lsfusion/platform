...
Note that you can use any other expressions instead of the [`OVERRIDE` operator](../language/OVERRIDE_operator.md). In particular, [`(+)` and `(-)` operators](../paradigm/Arithmetic_operators_plus_minus_etc.md) may be the most frequently used.
