---
slug: "/How-to_Internationalization"
title: 'How-to: Internationalization'
---

The system supports  [internationalization](../paradigm/Internationalization.md) by passing to the client values localized according to the language chosen by the user. All values in braces are localized. Let's assume that we need to implement a simple form with a list of books and their prices that we can create/delete.
...
Remember that such expressions cannot be used in [materializations](../paradigm/Materializations.md). 
