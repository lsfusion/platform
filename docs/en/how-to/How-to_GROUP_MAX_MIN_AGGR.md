...
The difference between Option 2 and Option 1 is that declaration of this property puts a [constraint](../paradigm/Constraints.md) on the uniqueness of book IDs. Any attempt to add two or more books with the same ID will result in the error message.
