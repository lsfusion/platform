...
In order to implement this logic, you need to create an abstract `Invoice` [class](../paradigm/Classes.md) with the necessary set of [abstract properties](../paradigm/Property_extension.md).
