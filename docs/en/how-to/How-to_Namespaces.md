...
Occasionally, you will find yourself in situations where you will need to use the same [name](../paradigm/Naming.md) for different system elements. For this purpose, you can assign them to different namespaces that are defined for a module using the [`NAMESPACE` statement](../language/Module_header.md). By default, the namespace matches the name of the module.
...
or the namespace priority has not been specified using the [`PRIORITY` statement](../language/Module_header.md),
