...
To declare actions that implement the expansion and collapse operations of object tree elements, use the [`EXPAND`](../language/EXPAND_operator.md) and [`COLLAPSE`](../language/COLLAPSE_operator.md) operators.
