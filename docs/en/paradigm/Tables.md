...
To create tables, use the [`TABLE` statement](../language/TABLE_statement.md). To specify the table which should store the property, use the [`TABLE` option](../language/Property_options.md) in the property options.
