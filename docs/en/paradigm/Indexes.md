...
To create indexes, use the [`INDEX` statement](../language/INDEX_statement.md) for an index by an arbitrary field list of one table or the [`INDEXED` option](../language/Property_options.md#indexed) for an index by one materialized property.
