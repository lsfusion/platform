...
|[`LIKE`](LIKE_operator.md)<br/>[`MATCH`](MATCH_operator.md)|[Comparison with a pattern](Comparison_operators_=_etc.md)<br/>[Full-text search](Comparison_operators_=_etc.md)|Binary<br/>Binary|
