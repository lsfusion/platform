...
Use the `PARENT` block to create [hierarchical object groups](../paradigm/Interactive_view.md#treegroup). To do that, specify a property that will define the parent element for an object (or several objects if an object group contains several ones).
