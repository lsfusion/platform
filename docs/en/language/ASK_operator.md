...
The `ASK` operator creates an [action](../paradigm/Actions.md) that asks the user a question or requests confirmation in a [dialog form](../paradigm/Show_message_MESSAGE_ASK.md#dialog).
...
- `elseOperator`
    ...
    A context-dependent action operator that is executed if the input is [cancelled](../paradigm/Value_input.md#result). Only the parameters of the created action can be used as parameters.
