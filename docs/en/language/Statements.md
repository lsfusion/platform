...
The code of any [module](../paradigm/Modules.md) in **[lsFusion](Language.md)** consists of a sequence of *statements*.
...
-   [The `+=` statement](plus_equals_statement.md) 
-   [The `ACTION+` statement](ACTION_plus_statement.md)
