---
slug: "/NEWCONNECTION_operator"
title: 'NEWCONNECTION operator'
---

The `NEWCONNECTION` operator creates an [action](../paradigm/Actions.md) that executes another action while preserving [external connections](../paradigm/New_connection_NEWCONNECTION.md) (`SQL`, `TCP`, `DBF`) across [`EXTERNAL`](EXTERNAL_operator.md) calls.
