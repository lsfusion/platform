...
The `JSON` operator is property that creates JSON from [specified properties](../paradigm/Data_export_EXPORT.md) or, in common case, from [form](../paradigm/In_a_structured_view_EXPORT_IMPORT.md). 
