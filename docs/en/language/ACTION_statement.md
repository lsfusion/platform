---
slug: "/ACTION_statement"
title: 'ACTION statement'
---

The `ACTION` statement creates an [action](../paradigm/Actions.md).
...
The `ACTION` statement declares a new action and adds it to the current [module](../paradigm/Modules.md).
