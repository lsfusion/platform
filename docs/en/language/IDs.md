...
Identifiers or *IDs* in the **lsFusion** language are used for naming or referring to [system elements](../paradigm/Element_identification.md), parameters of [properties](../paradigm/Properties.md) and [actions](../paradigm/Actions.md), [static objects](../paradigm/Static_objects.md), properties and actions on a form, and other entities.
...
*Composite ID* is used to reference a system element by name, with the option  of specifying а [namespace](../paradigm/Naming.md#namespace). It can consist of either a single simple ID or two simple IDs separated by a dot. If you need to specify a namespace, you first specify the namespace name, then a dot, followed by the name of the system element.
...
*Class ID* is used to reference either a [user](../paradigm/User_classes.md) or [built-in](../paradigm/Built-in_classes.md) class. For a user class, the identifier is represented as a composite ID, while for a built-in class, special [keywords](../paradigm/Built-in_classes.md) are used to specify the built-in class.
...
*Static object ID* is used to reference a [static object](../paradigm/Static_objects.md) of a class. It consists of a user class ID and a simple ID (name of the static object) separated by a dot.
...
*Object group ID* is used to reference an [object group](../paradigm/Form_structure.md) (or object) on a form. It consists of a composite ID that specifies the form and the name of the object group (or the name of the object), separated by a dot.
