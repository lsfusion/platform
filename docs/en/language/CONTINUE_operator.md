...
The `CONTINUE` operator creates an [action](../paradigm/Actions.md) that implements move to the [next iteration of the cycle](../paradigm/Next_iteration_CONTINUE.md).
