---
slug: "/Change_operators_SET_CHANGED_etc"
...
To declare a property using change operators, the following [syntax constructs](../language/Change_operators.md) are used. 
