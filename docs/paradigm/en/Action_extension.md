...
This technique uses two language constructs: the [`ABSTRACT` operator](../language/ABSTRACT_action_operator.md) for declaring an abstract action and the [`ACTION+` statement](../language/ACTION_plus_statement.md) for adding implementations.
