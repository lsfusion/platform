...
:::info
In the current platform implementation, initial values and automatic change are supported only for primitive input operators (`INPUT`) and dialog form opening (`DIALOG`).
:::
