...
|Implementation|Implemented|**Not yet implemented**|**Not yet implemented**|Implemented|
...
The consequence constraint is created using the [`=>` statement](../language/=gt_statement.md). The definiteness constraint is set with the [`NONULL` option](../language/Property_options.md) specified when a property is declared.
