---
slug: "/New_threads_NEWTHREAD_NEWEXECUTOR"
...
To declare an action that executes another action in a new thread, use the [`NEWTHREAD` operator](../language/NEWTHREAD_operator.md). To create an execution service and group nested `NEWTHREAD`s into it, use the [`NEWEXECUTOR` operator](../language/NEWEXECUTOR_operator.md).
