...
To declare an action showing a message, use the [`MESSAGE` operator](../language/MESSAGE_operator.md). To display the message in dialog form, use the [`ASK` operator](../language/ASK_operator.md).
