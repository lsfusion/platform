...
This technique uses two language constructs: the [`ABSTRACT` operator](../language/ABSTRACT_operator.md) for declaring an abstract property and the [`+=` statement](../language/plus_equals_statement.md) for adding implementations.
