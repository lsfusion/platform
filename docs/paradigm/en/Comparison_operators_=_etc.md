...
Description of common [comparison operators](../language/Comparison_operators.md).  
To create a property that compares a string with a pattern, use the [`LIKE` operator](../language/LIKE_operator.md). For full-text search, use the [`MATCH` operator](../language/MATCH_operator.md).
