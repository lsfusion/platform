...
The destination is defined by a string [expression](../language/Expression.md) whose value is the URL to write to. The following URL types are supported: **FILE**, **FTP**, **FTPS**, **SFTP**.

### Language

To declare an action that writes a file, use the [`WRITE` operator](../language/WRITE_operator.md).
