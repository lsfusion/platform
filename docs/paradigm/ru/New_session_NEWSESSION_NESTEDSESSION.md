...
Опция действует, когда оператор выполняется не во время уже идущей транзакции применения текущей сессии: внутри такой транзакции платформа уходит в рекурсивное применение и отдельное SQL-соединение не открывает.
