...
Действия, возвращающие результат, можно также использовать при задании других свойств в теле действия — в этом случае результат подставляется на месте вызова.
