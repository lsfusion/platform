...
В этой технике используются две языковые конструкции: [оператор `ABSTRACT`](../language/ABSTRACT_operator.md) для объявления абстрактного свойства и [инструкция `+=`](../language/plus_equals_statement.md) для добавления к нему реализации.
