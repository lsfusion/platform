...
Для операторов равенства и упорядочивания оба операнда должны принадлежать совместимым классам — одному семейству встроенных классов либо классам, связанным наследованием; сравнивать значения несвязанных классов не допускается.
