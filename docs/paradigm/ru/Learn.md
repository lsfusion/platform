...
Этот раздел содержит рекомендации, которые помогают ИИ-ассистентам читать и писать код на **lsFusion**, — краткий обзор элементов языка и обязательные правила написания кода.
