...
Для создания индексов необходимо использовать [инструкцию `INDEX`](../language/INDEX_statement.md) для индекса по произвольному списку полей одной таблицы или [опцию `INDEXED`](../language/Property_options.md#indexed) для индекса по одному материализованному свойству.
