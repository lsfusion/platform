...
Для реализации полиморфизма наследование, как правило, используется вместе с механизмами расширения [свойств](Property_extension.md) и [действий](Action_extension.md). 
...
3.  Невозможно несколько раз наследовать один и тот же класс (он всегда остаётся одним классом, а не одним и тем же классом в виде двух отдельных).
