...
*Логические операторы* создают [свойства](Properties.md), которые рассматривают свои операнды как логические значения [класса `BOOLEAN`](Built-in_classes.md), и возвращаемым значением которых также является значение класса `BOOLEAN`. Если значение операнда логического оператора не равно `NULL`, то операнд рассматривается как значение `TRUE` класса `BOOLEAN`, иначе `NULL`. Результат всегда равен либо `TRUE`, либо `NULL`, но никогда не `FALSE`.
...
Описание [синтаксиса логических операторов](../language/AND_OR_NOT_XOR_operators.md).
