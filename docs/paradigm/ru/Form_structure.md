...
При определении [группы отображения](#drawgroup) свойства его группы-в-колонки игнорируются.
...
Для создания новой формы и описания ее структуры предназначена [инструкция `FORM`](../language/FORM_statement.md).
