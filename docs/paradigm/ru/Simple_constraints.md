...
|Реализация|Реализовано|**Пока не реализовано**|**Пока не реализовано**|Реализовано|
...
Ограничение-следствие создаётся с помощью [инструкции `=>`](../language/=gt_statement.md). Ограничение определённости задаётся [опцией `NONULL`](../language/Property_options.md), указываемой при объявлении свойства.
