...
### Настройки форм и клиента {#formSettings}

Эти признаки задаются по роли и объединяются по ролям пользователя.

| Свойство                                     | Что делает                                                               |
|----------------------------------------------|----------------------------------------------------------------------------|
| `forbidDuplicateForms[UserRole]`             | при открытии формы из [навигатора](Navigator.md) активировать уже открытую закладку этой формы вместо новой |
