...
Агрегат по всему классу, такой как `GROUP SUM calcProp(Cls o)`, не подходит: он возвращает значение по всем объектам и подмешивает посторонние данные. Значение именно нужного объекта можно получить двумя способами.
