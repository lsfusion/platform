...
|`class`|CSS-классы компонента (через пробел)|Выражение (строковое значение)|NULL|todo|
...
|`captionCharHeight`|todo|Целочисленный литерал|`-1`|`5`|
|`captionWidth`|Ширина заголовка свойства в пикселях|Целочисленный литерал|`-1`|`100`|
|`charHeight`|todo|Целочисленный литерал|`-1`|`100`|
|`charWidth`|todo|Целочисленный литерал|`-1`|`100`|
