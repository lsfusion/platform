...
|`attr`|HTML аттрибуты для заголовка элемента (пары ключ-значение)|Строковый литерал|tooltip по умолчанию|`'attr1=xxx;attr2=5'`|
|`valueAttr`|HTML аттрибуты для значения элемента (пары ключ-значение)|Строковый литерал|tooltip по умолчанию|`'attr1=xxx;attr2=5'`|
