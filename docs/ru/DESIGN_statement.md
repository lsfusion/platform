...
|`captionClass`|Класс заголовка свойства или действия|Строковый литерал|Класс заголовка свойства или действия|`'caption-class'`|
...
|`panelCaptionAlignment`|Способ выравнивания компонента заголовка внутри контейнера. Допустимые значения: `START` (В начале), `CENTER` (В центре), `END` (В конце), `STRETCH` (Растянуть).|Тип выравнивания|`START`|`STRETCH`|
...
|`panelCommentFirst`|Указание того, что в панели необходимо рисовать сначала комментарий, а значение свойства|Дополненный логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
