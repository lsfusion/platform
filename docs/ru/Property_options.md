...
- `INDEXED`
    ...
    Ключевое слово, указание которого создает [индекс](Indexes.md) по этому свойству. Может использоваться только для [материализованного](Materializations.md) свойства. Аналогично использованию [инструкции `INDEX`](INDEX_statement.md).
