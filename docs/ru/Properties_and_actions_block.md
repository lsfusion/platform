...
- `COLUMN`
  ...
  Ключевое слово, указывающее на то, что в [виде представления](Interactive_view.md#property) `PIVOT` свойство на форме будет добавлена в колонки.

- `ROW`

  Ключевое слово, указывающее на то, что в виде представления `PIVOT` свойство на форме будет добавлена в ряды.

- `MEASURE`

  Ключевое слово, указывающее на то, что в виде представления `PIVOT` свойство на форме будет добавлена в значения.
