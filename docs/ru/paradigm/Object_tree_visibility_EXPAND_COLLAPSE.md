---
slug: "/Object_tree_visibility_EXPAND_COLLAPSE"
...
Для объявления действий, реализующих операции разворачивания и сворачивания элементов дерева объектов, используются операторы [`EXPAND`](../language/EXPAND_operator.md) и [`COLLAPSE`](../language/COLLAPSE_operator.md).
