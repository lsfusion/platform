...
Правила соотнесения параметров свойства с этой таблицей описаны в статье [оператора `FORMULA`](../language/FORMULA_operator.md).
