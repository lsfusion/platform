...
Оператор `IF ... THEN` - создание [действия](../paradigm/Actions.md), реализующего [ветвление](../paradigm/Branching_CASE_IF_MULTI.md#single) с одним условием (одиночная форма).
