...
- `imageSetting`
    ...
    - `IMAGE [imageLiteral]`
        ...
        [Указание иконки](../paradigm/Icons.md#manual), которая будет отображаться в качестве иконки действия. Если `imageLiteral` не указывается, то происходит переключение в режим [автоматической установки](../paradigm/Icons.md#auto) иконки.
