...
Оператор `CHANGECLASS` - создание [действия](../paradigm/Actions.md), которое [изменяет классы объектов](../paradigm/Class_change_CHANGECLASS_DELETE.md).
...
- `className`
    ...
    Имя класса, на который необходимо изменить классы объектов. [Составной идентификатор](IDs.md#cid), так как класс должен быть [пользовательским](../paradigm/User_classes.md).
