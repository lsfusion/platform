---
slug: "/Change_operators"
title: 'Операторы изменений'
---

Операторы изменений - набор операторов реализующих определение различных типов [изменений значений свойств](../paradigm/Change_operators_SET_CHANGED_etc.md). 
...
Операторы изменений создают [свойства](../paradigm/Properties.md), которые определяют, произошли ли для некоторого свойства в текущей сессии те или иные виды изменений. Это [контекстно-зависимые](Property_operators.md) операторы-свойства, которые могут использоваться внутри [выражений](Expression.md). Внутри обработчика [события](../paradigm/Events.md#change) они переключаются в событийный режим и сообщают об изменениях с момента предыдущего срабатывания этого события.
