...
*Типизированный параметр* используется для обозначения [параметра свойства](../paradigm/Properties.md) (действия). Он состоит из необязательного идентификатора класса параметра и простого идентификатора, обозначающего имя параметра.
