...
Оператор `MULTI` - создание [действия](../paradigm/Actions.md), реализующего [ветвление](../paradigm/Branching_CASE_IF_MULTI.md#poly) (полиморфная форма).
...
[Тип взаимоисключения](../paradigm/Branching_CASE_IF_MULTI.md#exclusive). Определяет, могут ли несколько условий выбора действия одновременно выполняться при некотором наборе наборе параметров. Задается одним из ключевых слов:
