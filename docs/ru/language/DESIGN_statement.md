...
|`background`|Цвет, который будет использоваться для отображения фона компонента|Выражение (значение класса [COLOR](Literals.md#colorliteral))|`#FFFFFF`|`#FFFFCC`<br/>`RGB(255, 0, 0)`|
...
|`panelCaptionVertical`|**deprecated since version 6, используйте `captionVertical`**|Дополненный логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`captionVertical`|Указание того, что в панели необходимо рисовать заголовок компонента свойства или действия сверху от значения|Дополненный логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`panelCaptionLast`|**deprecated since version 6, используйте `captionLast`**|`FALSE`|`TRUE`<br/>`FALSE`|
|`captionLast`|Указание того, что в панели необходимо рисовать сначала значение, а потом заголовок свойства|Дополненный логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
...
|`captionAlignmentVert`|Способ выравнивания заголовка компонента по вертикали. Допустимые значения: `START` (В начале), `CENTER` (В центре), `END` (В конце), `STRETCH` (Растянуть).|Тип выравнивания|`START`|`STRETCH`|
|`showIf`|Указание условия, при котором контейнер будет отображаться|Выражение (логическое значение)|`NULL`|`isLeapYear(date)`<br/>`hasComplexity(a, b)`|
...
|`image`|todo|Выражение (строковое значение)|`NULL`|todo|
|`collapsible`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`popup`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
...
|`custom`|todo|Выражение (строковое значение)|NULL|todo|
...
|`defaultCompare`|Фильтр по умолчанию. Допустимые значения: `=`, `>`, `<`, `>=`, `<=`, `!=`, `=*` (содержит), `=@` (нечёткий поиск).|Строковый литерал|`=*`|`>`|
...
|`charHeight`|Высота ячейки значения свойства в символах (строках)|Целочисленный литерал|`-1`|`100`|
|`charWidth`|Ширина ячейки значения свойства в символах|Целочисленный литерал|`-1`|`100`|
...
|`showChangeMouse`|Указание того, что в заголовок свойства будет включено название действия мыши, по которому будет начато редактирование|Дополненный логический литерал|`TRUE`|`TRUE`<br/>`FALSE`|
...
|`inline`|todo|Дополненный логический литерал|changeKey = `NULL`|`TRUE`<br/>`FALSE`|
|`panelColumnVertical`|todo|Logical literal|`FALSE`|`TRUE`<br/>`FALSE`|
|`class`|CSS-классы свойства (через пробел)|Выражение (строковое значение)|NULL|todo|
|`footerClass`|CSS-классы футера свойства (через пробел)|Выражение (строковое значение)|NULL|todo|
...
|`inputType`|todo|Строковый литерал|NULL|todo|
...
|`comment`|Комментарий свойства или действия|Выражение (строковое значение)|Комментарий свойства или действия|`'Комментарий'`|
|`commentClass`|Класс комментария свойства или действия|Выражение (строковое значение)|Класс комментария свойства или действия|`'comment-class'`|
...
|`panelCustom`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
...
|`highlightDuplicate`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`wrapWordBreak`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`ellipsis`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`collapse`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`captionWrap`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`captionWrapWordBreak`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`captionEllipsis`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
|`captionCollapse`|todo|Логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
...
|`toolbarActions`|todo|Дополненный логический литерал|`FALSE`|`TRUE`<br/>`FALSE`|
...
|`select`|todo|Выражение (строковое значение)|NULL|todo|
