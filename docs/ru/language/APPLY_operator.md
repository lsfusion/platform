...
Оператор `APPLY` - создание [действия](../paradigm/Actions.md), [применяющего изменения](../paradigm/Apply_changes_APPLY.md) в базу данных.
