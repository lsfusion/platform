...
Оператор `IF ... THEN` - создание [свойства](../paradigm/Properties.md), реализующего [выбор](../paradigm/Selection_CASE_IF_MULTI_OVERRIDE_EXCLUSIVE.md) с одним условием (одиночная форма).
