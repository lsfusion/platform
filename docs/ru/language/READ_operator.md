...
Оператор `READ` - создание [действия](../paradigm/Actions.md), [считывающего файл](../paradigm/Read_file_READ.md) из внешнего ресурса в [свойство](../paradigm/Properties.md).
