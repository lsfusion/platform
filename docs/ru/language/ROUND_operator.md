...
- `numExpr`
    ...
    [Выражение](Expression.md), значение которого определяет округляемое число. Значение должно принадлежать одному из [числовых классов](../paradigm/Built-in_classes.md).
