...
Оператор `NESTEDSESSION` - создание [действия](../paradigm/Actions.md), которое выполняет другое действие во [вложенной сессии](../paradigm/New_session_NEWSESSION_NESTEDSESSION.md#nested).
