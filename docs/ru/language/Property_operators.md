...
*Оператор-свойство* - это синтаксическая конструкция, описывающая [оператор](../paradigm/Property_operators_paradigm.md), создающий [свойство](../paradigm/Properties.md). 
