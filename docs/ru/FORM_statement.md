...
- `imageSetting`
    ...
    - `IMAGE [imageLiteral]`
        ...
        [Указание иконки](Icons.md#manual) формы. Если `imageLiteral` не указывается, то происходит переключение в режим [автоматической установки](Icons.md#auto) иконки.
