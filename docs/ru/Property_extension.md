...
В этой технике используются две языковые конструкции: [оператор `ABSTRACT`](ABSTRACT_operator.md) для объявления абстрактного свойства и [инструкция `+=`](plus_equals_statement.md) для добавления к нему реализации.
