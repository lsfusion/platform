...
|[`LIKE`](LIKE_operator.md)<br/>[`MATCH`](MATCH_operator.md)|[Сравнение с шаблоном](Comparison_operators_=_etc.md)<br/>[Полнотекстовый поиск](Comparison_operators_=_etc.md)|Бинарный<br/>Бинарный|
