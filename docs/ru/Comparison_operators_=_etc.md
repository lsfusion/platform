...
Для создания свойства, сравнивающего строку с шаблоном, используется [оператор `LIKE`](LIKE_operator.md). Для полнотекстового поиска используется [оператор `MATCH`](MATCH_operator.md).
