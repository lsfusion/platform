...
- `imageSetting`
    ...
    - `IMAGE [imageExpr]`
        ...
        [Указание иконки](Icons.md#manual) элемента навигатора. Если `imageExpr` не указывается, то происходит переключение в режим [автоматической установки](Icons.md#auto) иконки. 
