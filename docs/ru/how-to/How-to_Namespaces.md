---
slug: "/How-to_Namespaces"
title: 'How-to: Пространства имен'
---

Иногда возникают ситуации, когда необходимо использовать одинаковое [имя](../paradigm/Naming.md) для разных элементов системы. Для этой цели их можно отнести к разным пространствам имен, которое задается для модуля через [инструкцию `NAMESPACE`](../language/Module_header.md). По умолчанию, пространство имен совпадает с именем модуля.
...
или указан приоритет пространств имен через [инструкцию `PRIORITY`](../language/Module_header.md)
