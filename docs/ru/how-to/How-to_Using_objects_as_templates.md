...
Нужно реализовать [действие](../paradigm/Actions.md), которое создаст на основе заказа счет и откроет форму по его редактированию.
...
Нужно реализовать [действие](../paradigm/Actions.md), которое для счета вызовет диалог со списком заказов и добавит строки из выбранного.
