...
Use the isSubstring property (defined in the `Utils` system [module](../paradigm/Modules.md)) to identify whether a given line contains another line.
