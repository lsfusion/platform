...
A guide to **lsFusion** programming, based on the author's experience (available in Russian only). The book gives a general idea of the application development process, teaches how to effectively read code written in the platform language, and shows common patterns for solving typical problems encountered in real development.
