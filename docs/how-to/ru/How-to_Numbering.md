...
Следующий номер здесь выводится из уже сохранённых номеров, поэтому нумерация не расходится с данными: книги, пришедшие с уже заполненным номером (импорт, копирование), событие благодаря своему условию пропускает, но максимум учитывает их номера, и следующее сгенерированное значение с ними не конфликтует. Отдельный хранимый счётчик, не выводимый из данных, при добавлении таких книг не увеличивался бы — он мог бы отстать от сохранённого максимума, и сгенерированные номера конфликтовали бы с существующими.
