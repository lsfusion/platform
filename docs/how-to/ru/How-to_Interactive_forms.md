...
4. [Дизайн](How-to_Design.md). Настройка [дизайна](../paradigm/Form_design.md) формы.
...
7. [Навигатор](How-to_Navigator.md). Способ добавления форм в [навигатор](../paradigm/Navigator.md).
...
12. [Пользовательские клиентские модули JS](How-to_Custom_client_JS_modules.md). Сборка и автоматическая регистрация собственного браузерного JavaScript (и React) из папки `src/main/web`.
13. [Пользовательские представления формы на React](How-to_Custom_React_views.md). Отрисовка контейнера формы React-компонентом через `DESIGN custom`.
14. [API контроллера пользовательского представления](How-to_Custom_view_controller.md). Чтение и изменение состояния формы из пользовательского представления (и `INTERNAL CLIENT`) через контроллер.
