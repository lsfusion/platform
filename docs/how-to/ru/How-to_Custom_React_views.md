...
| `data.<g>` | `options` — пользовательские опции группы, там, где представление рисует её строки; `properties` — имена того, что несёт этот узел |
