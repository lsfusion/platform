...
Нужно добавить их в [навигатор](../paradigm/Navigator.md) в новую папку `'Приложение'` снизу от основного тулбара.
...
Указав `WINDOW` для элемента `application`, мы указали, что все его потомки должны отображаться в системном [окне](../paradigm/Navigator_design.md) `toolbar`. Это будет выглядеть следующим образом :
