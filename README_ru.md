...
Документация в каталоге `docs/` выпускается под отдельной лицензией [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.ru), а примеры кода внутри неё переданы в общественное достояние по [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/deed.ru), то есть их можно копировать в свои приложения без каких-либо условий. Подробности — в [LICENSING.md](LICENSING.md).