...
import static lsfusion.interop.form.layout.IsInsideSimplexConstraint.getContainerInsets;
...
//            if (mapComponents.get(component).constraints.fillVertical == 0)
    ...
    public static void loadLibraries() throws IOException {
        SystemUtils.loadLibrary("lpsolve55", "/lsfusion/client/form/", SimplexLayout.class);
        SystemUtils.loadLibrary("lpsolve55j", "/lsfusion/client/form/", SimplexLayout.class);
    }
}
