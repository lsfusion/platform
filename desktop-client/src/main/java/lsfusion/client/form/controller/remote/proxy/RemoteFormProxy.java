...
public class RemoteFormProxy extends RemoteRequestObjectProxy<RemoteFormInterface> implements RemoteFormInterface {
    ...
    public ServerResponse voidFormAction(long requestIndex, long lastReceivedRequestIndex, long waitRequestIndex) throws RemoteException {
        logRemoteMethodStartVoidCall("voidFormAction");
        ServerResponse result = target.voidFormAction(requestIndex, lastReceivedRequestIndex, waitRequestIndex);
    ...
    @Override
    public byte[] getAsyncValues(long requestIndex, long lastReceivedRequestIndex, int propertyID, byte[] fullKey, String actionSID, String value, int index) throws RemoteException {
