...
//        };
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed( ActionEvent e ) {
            ...
            BasicComboBoxUI ui = (BasicComboBoxUI)getUIOfType(comboBox.getUI(), BasicComboBoxUI.class);
            if (key == HIDE) {
        ...
        private Object getUIOfType(ComponentUI ui, Class klass) {
    ...
    private class Handler implements ActionListener, FocusListener,
        ...
        private boolean isTypeAheadKey( KeyEvent e ) {
            return !e.isAltDown() && !isMenuShortcutKeyDown(e);
        }
        ...
        //todo: added to ignore focus transfer between combobox and inner text field
