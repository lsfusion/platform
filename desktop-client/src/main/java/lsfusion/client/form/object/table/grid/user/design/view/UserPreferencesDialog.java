...
public abstract class UserPreferencesDialog extends JDialog {
    ...
    private void okButtonPressed() {
        ...
        for (UserPreferencesPropertyListItem propertyItem : visibleListModel.toArray()) {
            ...
            initialTable.setUserColumnSettings(propertyItem.property, propertyItem.getUserCaption(true), propertyItem.getUserPattern(true), visibleListModel.indexOf(propertyItem), userHide);
