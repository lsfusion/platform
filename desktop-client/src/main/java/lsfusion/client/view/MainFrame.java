...
public abstract class MainFrame extends JFrame {
    ...
    public abstract ClientFormDockable runForm(ModalityType modalityType, String canonicalName, String formSID, boolean forbidDuplicate, RemoteFormInterface remoteForm, byte[] firstChanges, FormCloseListener closeListener);
}