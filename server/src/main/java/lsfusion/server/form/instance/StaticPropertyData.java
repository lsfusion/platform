...
public class StaticPropertyData<Prop extends PropertyReaderEntity> {
    ...
    public void add(ImSet<ObjectEntity> objects, ImMap<Prop, ImMap<ImMap<ObjectEntity, Object>, Object>> data, ImSet<ObjectEntity> parentColumnObjects, ImSet<ObjectEntity> thisColumnObjects, final ImMap<ImMap<ObjectEntity, Object>, ImOrderSet<ImMap<ObjectEntity, Object>>> columnData) {
