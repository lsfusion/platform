...
//        }
    ...
    public void synchronizePropertyEntities(boolean actions) {
        ...
        try {
            ...
            properties.add(new ImportProperty(selectPropertyField, reflectionLM.selectProperty.getMapping(keyProperty)));
            ...
            ImportTable table = new ImportTable(asList(canonicalNamePropertyField, dbNamePropertyField, captionPropertyField, loggablePropertyField,
                    storedPropertyField, isSetNotNullPropertyField, disableInputListPropertyField, selectPropertyField, returnPropertyField,
