...
public class CheckAggregationsMultiThreadAction extends MultiThreadAction {

    public CheckAggregationsMultiThreadAction(ServiceLogicsModule LM, ValueClass... classes) {
        super(LM,classes);
    }
