...
public class EvalAction<P extends PropertyInterface> extends SystemExplicitAction {
    private final LP<P> source;
    private final List<LP<P>> params;
    private final ImMap<P, ClassPropertyInterface> mapSource;
    private boolean action;

    public EvalAction(LocalizedString caption, LP<P> source, List<LP<P>> params, boolean action) {
