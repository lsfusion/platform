...
/**
 * Strict argument unwrappers for JSON tool calls. Replaces {@code JSONObject.optString} /
 ...
 */
public final class JsonToolArgs {
    private JsonToolArgs() {}
     ...
     * must be a string}".
     */
    public static String getStringAt(JSONObject obj, String key, String origin) {
