...
public class SQLSession extends MutableClosedObject<OperationOwner> {
    ...
    private Map<String, Integer> attemptCountMap;
...
//        fifo.add("E"  + getCurrentTimeStamp() + " " + this + " " + e.getStackTrace());
    ...
    public Map<String, Integer> incAttemptCount(Map<String, Integer> attemptCountMap, String description) {
        Integer count = attemptCountMap.get(description);
        attemptCountMap.put(description, count == null ? 1 : (count + 1));
        return attemptCountMap;
    }

    public Map<String, Integer> decAttemptCount(Map<String, Integer> attemptCountMap, String description) {
        Integer count = attemptCountMap.get(description);
        if (count != null) {
            if (count <= 1)
    ...
    public int getAttemptCountSum(Map<String, Integer> attemptCountMap) {
        int result = 0;
        for(Map.Entry<String, Integer> entry : attemptCountMap.entrySet()) {
