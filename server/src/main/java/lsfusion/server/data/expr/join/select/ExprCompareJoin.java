...
public abstract class ExprCompareJoin<T extends BaseExpr, This extends ExprCompareJoin<T, This>> extends AbstractOuterContext<This> implements WhereJoin<Integer, This> {

    public T expr1;
    public BaseExpr expr2;

    public ExprCompareJoin(T expr1, BaseExpr expr2) {
        this.expr1 = expr1;
        this.expr2 = expr2;
    }
    ...
    protected abstract This createThis(T expr1, BaseExpr expr2);
    protected This translate(MapTranslate translator) {
        return createThis((T) expr1.translateOuter(translator), expr2.translateOuter(translator));
    }
