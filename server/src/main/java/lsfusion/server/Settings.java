...
public class Settings {
    ...
    // проблема в "орел-решка", когда есть или 0 или очень большая статистика, сейчас берется пессимистичный вариант основным, к нему присоединяются "хорошие" варианты с индексом
