...
public class Settings {
    ...
    private int collapseStatsCount = 20;
    private int collapseStatsComplexity = 1000; // 100 - лучше в несколько раз на очень больших запросов, и даже 200, но все же иногда попадает в "орел-решку" и вообще в неравномерную статистику
