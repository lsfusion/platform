...
//            splitting paramProps to using extend params, and not using (if there is a explicit classes, move from not extend params to extend
            ...
            if(actions != null) {
                ...
                actions.addBeforeAction(addScriptedJoinAProp(mainAction, returnDataProp, paramProps, false));
            }
        }                
...
//        assert targetProp == null;
    ...
    public LAWithParams addScriptedJoinAProp(NamedPropertyUsage pUsage, NamedPropertyUsage toUsage, List<LPWithParams> properties, List<TypedParameter> params) throws ScriptingErrorLog.SemanticErrorException {
        return addScriptedJoinAProp(pUsage, toUsage, properties, params, false);
    }

    public LAWithParams addScriptedJoinAProp(NamedPropertyUsage pUsage, NamedPropertyUsage toUsage, List<LPWithParams> properties, List<TypedParameter> params, boolean allServers) throws ScriptingErrorLog.SemanticErrorException {
        ...
        return addScriptedJoinAProp(mainAction, result, properties, allServers);
    }
    ...
    public LAWithParams addScriptedJoinAProp(LA mainAction, List<LPWithParams> properties) throws ScriptingErrorLog.SemanticErrorException {
        return addScriptedJoinAProp(mainAction, null, properties, false);
    }
    public LAWithParams addScriptedJoinAProp(LA mainAction, LP result, List<LPWithParams> properties, boolean allServers) throws ScriptingErrorLog.SemanticErrorException {
        checks.checkParamCount(mainAction, properties.size());

        List<Object> resultParams = getParamsPlainList(properties);
        LA action = addJoinAProp(null, LocalizedString.NONAME, result, mainAction, allServers, resultParams.toArray());
