...
//        ImList<Type> exprTypes = getTypesForExportProp(exprs, newContext);
    ...
    public LAWithParams addScriptedNewThreadActionProperty(LAWithParams actionProp, LCPWithParams connectionProp, LCPWithParams periodProp, LCPWithParams delayProp) {
    ...
    public LAWithParams addScriptedNewExecutorActionProperty(LAWithParams actionProp, LCPWithParams threadsProp) {
    ...
    public void addScriptedEvent(LCPWithParams whenProp, LAWithParams event, List<LCPWithParams> orders, boolean descending, Event baseEvent, List<LCPWithParams> noInline, boolean forceInline, DebugInfo.DebugPoint debugPoint) {
        if(noInline==null) {
            noInline = new ArrayList<>();
