...
import lsfusion.server.logics.action.external.ExternalDBActionProperty;
import lsfusion.server.logics.action.external.ExternalDBFActionProperty;
import lsfusion.server.logics.action.external.ExternalHTTPActionProperty;
import lsfusion.server.logics.action.file.ReadActionProperty;
import lsfusion.server.logics.action.file.WriteActionProperty;
...
import lsfusion.server.language.resolving.ResolvingErrors.ResolvingError;
