...
public class ThreadLocalContext {
    ...
    public static void requestFormUserInteraction(FormInstance remoteForm, ModalityType modalityType, boolean forbidDuplicate, String formId, ExecutionStack stack) throws SQLException, SQLHandledException {
        get().requestFormUserInteraction(remoteForm, modalityType, forbidDuplicate, formId, stack);
    }
