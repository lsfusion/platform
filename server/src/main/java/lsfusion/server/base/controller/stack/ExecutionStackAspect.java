...
public class ExecutionStackAspect {
    ...
    @Around("execution(lsfusion.server.logics.action.flow.FlowResult lsfusion.server.logics.action.ActionProperty.execute(lsfusion.server.logics.action.ExecutionContext))")
