...
//
    ...
    public void requestFormUserInteraction(FormInstance remoteForm, ModalityType modalityType, String inFormCanonicalName, Integer inComponentId, boolean forbidDuplicate, ExecutionStack stack) throws SQLException, SQLHandledException {
        assertNotUserInteractionInTransaction();
        ThreadLocalContext.requestFormUserInteraction(remoteForm, modalityType, inFormCanonicalName, inComponentId, forbidDuplicate, stack);
    }
