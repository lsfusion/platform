...
public class ScriptingLogicsModuleChecks {
    ...
    public void checkGroup(AbstractGroup group, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (group == null) {
            errLog.emitGroupNotFoundError(parser, name);
        }
    }

    public void checkClass(ValueClass cls, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (cls == null) {
            errLog.emitClassNotFoundError(parser, name);
        }
    }

    public void checkComponent(ComponentView component, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (component == null) {
            errLog.emitComponentNotFoundError(parser, name);
        }
    }

    public void checkProperty(LP lp, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (lp == null) {
            errLog.emitPropertyNotFoundError(parser, name);
        }
    }

    public void checkModule(LogicsModule module, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (module == null) {
            errLog.emitModuleNotFoundError(parser, name);
        }
    }

    public void checkNamespace(String namespaceName) throws ScriptingModuleErrorLog.SemanticError {
        if (!LM.getNamespaceToModules().containsKey(namespaceName)) {
            errLog.emitNamespaceNotFoundError(parser, namespaceName);
        }
    }

    public void checkWindow(AbstractWindow window, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (window == null) {
            errLog.emitWindowNotFoundError(parser, name);
        }
    }

    public void checkNavigatorElement(NavigatorElement element, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (element == null) {
            errLog.emitNavigatorElementNotFoundError(parser, name);
        }
    }

    public void checkTable(ImplementTable table, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (table == null) {
            errLog.emitTableNotFoundError(parser, name);
        }
    }

    public void checkForm(FormEntity form, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (form == null) {
            errLog.emitFormNotFoundError(parser, name);
        }
    }

    public void checkMetaCodeFragment(MetaCodeFragment code, String name) throws ScriptingModuleErrorLog.SemanticError {
        if (code == null) {
            errLog.emitMetaCodeFragmentNotFoundError(parser, name);
        }
    }

    public void checkParamCount(LP mainProp, int paramCount) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkDuplicateClass(String className, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
        LogicsModule module = BL.getModuleContainingClass(LM.getNamespace(), className);
        if (module != null) {
            errLog.emitAlreadyDefinedInModuleError(parser, "class", className, module.getName());
        }
    }

    public void checkDuplicateGroup(String groupName, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
        LogicsModule module = BL.getModuleContainingGroup(LM.getNamespace(), groupName);
        if (module != null) {
            errLog.emitAlreadyDefinedInModuleError(parser, "group", groupName, module.getName());
        }
    }

    public void checkDuplicateProperty(String propName, List<ResolveClassSet> signature, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
        LogicsModule module = BL.getModuleContainingLP(LM.getNamespace(), propName, signature);
        if (module != null) {
    ...
    public void checkDuplicateWindow(String windowName, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
        LogicsModule module = BL.getModuleContainingWindow(LM.getNamespace(), windowName);
        if (module != null) {
            errLog.emitAlreadyDefinedInModuleError(parser, "window", windowName, module.getName());
        }
    }

    public void checkDuplicateNavigatorElement(String name, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
        LogicsModule module = BL.getModuleContainingNavigatorElement(LM.getNamespace(), name);
        if (module != null) {
            errLog.emitAlreadyDefinedInModuleError(parser, "navigator", name, module.getName());
        }
    }

    public void checkDuplicateForm(String name, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
        LogicsModule module = BL.getModuleContainingForm(LM.getNamespace(), name);
        if (module != null) {
            errLog.emitAlreadyDefinedInModuleError(parser, "form", name, module.getName());
        }
    }

    public void checkDuplicateMetaCodeFragment(String name, int paramCnt, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkDuplicateTable(String name, BusinessLogics<?> BL) throws ScriptingModuleErrorLog.SemanticError {
        LogicsModule module = BL.getModuleContainingTable(LM.getNamespace(), name);
        if (module != null) {
            errLog.emitAlreadyDefinedInModuleError(parser, "table", name, module.getName());
        }
    }

    public void checkPropertyTypes(List<LPWithParams> properties, String errMsgPropType) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkStaticClassConstraints(boolean isAbstract, List<String> instNames, List<LocalizedString> instCaptions) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkClassParents(List<String> parents) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkFormulaClass(ValueClass cls) throws ScriptingModuleErrorLog.SemanticError {
        if (!(cls instanceof DataClass)) {
            errLog.emitFormulaReturnClassError(parser);
        }
    }

    public void checkFormDataClass(ValueClass cls) throws ScriptingModuleErrorLog.SemanticError {
        if (!(cls instanceof DataClass)) {
            errLog.emitFormDataClassError(parser);
        }
    }

    public void checkInputDataClass(ValueClass cls) throws ScriptingModuleErrorLog.SemanticError {
        if (!(cls instanceof DataClass)) {
            errLog.emitInputDataClassError(parser);
        }
    }

    public void checkChangeClassActionClass(ValueClass cls) throws ScriptingModuleErrorLog.SemanticError {
        if (!(cls instanceof ConcreteCustomClass)) {
            errLog.emitChangeClassActionClassError(parser);
        }
    }

    public void checkSingleImplementation(List<SQLSyntaxType> types) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkFormulaParameters(Set<Integer> params) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkNamedParams(LP property, List<String> namedParams) throws ScriptingModuleErrorLog.SemanticError {
        if (property.property.interfaces.size() != namedParams.size() && !namedParams.isEmpty()) {
            errLog.emitNamedParamsError(parser);
        }
    }

    public <T> void checkDistinctParameters(List<T> params) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkDistinctParametersList(List<LPWithParams> lps) throws ScriptingModuleErrorLog.SemanticError {
        for (LPWithParams lp : lps) {
            checkDistinctParameters(lp.usedParams);
        }
    }

    public void checkMetaCodeParamCount(MetaCodeFragment code, int paramCnt) throws ScriptingModuleErrorLog.SemanticError {
        if (code.parameters.size() != paramCnt) {
            errLog.emitParamCountError(parser, code.parameters.size(), paramCnt);
        }
    }

    public void checkGPropOrderConsistence(GroupingType type, int orderParamsCnt) throws ScriptingModuleErrorLog.SemanticError {
        if (type != GroupingType.CONCAT && type != GroupingType.LAST && orderParamsCnt > 0) {
            errLog.emitRedundantOrderGPropError(parser, type);
        }
    }

    public void checkGPropAggregateConsistence(GroupingType type, int aggrParamsCnt) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkGPropSumConstraints(GroupingType type, LPWithParams mainProp) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkGPropAggrConstraints(GroupingType type, List<LPWithParams> mainProps, List<LPWithParams> groupProps) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkGPropWhereConsistence(GroupingType type, LPWithParams where) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkActionProperty(LP property) throws ScriptingModuleErrorLog.SemanticError {
        if (!(property instanceof LAP<?>)) {
            errLog.emitNotActionPropertyError(parser);
        }
    }

    public void checkNavigatorAction(LAP<?> property) throws ScriptingModuleErrorLog.SemanticError {
        if (property.listInterfaces.size() > 0) {
            errLog.emitWrongNavigatorAction(parser);
        }
    }

    public void checkAddActionsClass(ValueClass cls) throws ScriptingModuleErrorLog.SemanticError {
        if (!(cls instanceof CustomClass)) {
            errLog.emitAddActionsClassError(parser);
        }
    }

    public void checkCustomClass(ValueClass cls) throws ScriptingModuleErrorLog.SemanticError {
        if (!(cls instanceof CustomClass)) {
            errLog.emitCustomClassExpectedError(parser);
        }
    }

    void checkCalculationProperty(LP property) throws ScriptingModuleErrorLog.SemanticError {
        if (!(property instanceof LCP<?>)) {
            errLog.emitNotCalculationPropertyError(parser);
        }
    }

    public void checkSessionProperty(LP property) throws ScriptingModuleErrorLog.SemanticError {
        if (!(property.property instanceof SessionDataProperty)) {
            errLog.emitNotSessionOrLocalPropertyError(parser);
        }
    }

    public void checkForActionPropertyConstraints(boolean isRecursive, List<Integer> oldContext, List<Integer> newContext) throws ScriptingModuleErrorLog.SemanticError {
        if (!isRecursive && oldContext.size() == newContext.size()) {
            errLog.emitForActionSameContextError(parser);
        }
    }

    public void checkRecursionContext(List<String> context, List<Integer> usedParams) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkNecessaryProperty(LPWithParams property) throws ScriptingModuleErrorLog.SemanticError {
        if (property.property == null) {
            errLog.emitNecessaryPropertyError(parser);
        }
    }

    public void checkIndexNecessaryProperty(List<LPWithParams> lps) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkStoredProperties(List<LPWithParams> lps) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkIndexNumberOfParameters(int paramsCount, List<LPWithParams> lps) throws ScriptingModuleErrorLog.SemanticError {
        int paramsInProp = -1;
        for (LPWithParams lp : lps) {
            if (lp.property != null) {
                if (paramsInProp == -1) {
    ...
    public void checkDeconcatenateIndex(LPWithParams property, int index) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkPartitionWindowConsistence(PartitionType partitionType, boolean useLast) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkPartitionUngroupConsistence(LP ungroupProp, int groupPropCnt) throws ScriptingModuleErrorLog.SemanticError {
...
//    }
    ...
    public void checkAbstractProperty(LCP property, String propName) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkAbstractAction(LAP action, String actionName) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkEventNoParameters(LP property) throws ScriptingModuleErrorLog.SemanticError {
        if (property.property.interfaces.size() > 0) {
            errLog.emitEventNoParametersError(parser);
        }
    }

    public void checkChangeClassWhere(boolean contextExtended, LPWithParams param, LPWithParams where, List<ScriptingLogicsModule.TypedParameter> newContext) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkAddObjTOParams(int contextSize, List<LPWithParams> toPropMapping) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkAbstractTypes(boolean isCase, boolean implIsCase) throws ScriptingModuleErrorLog.SemanticError {
    ...
    public void checkRange(String valueType, int value, int lbound, int rbound) throws ScriptingModuleErrorLog.SemanticError {
        if (value < lbound || value > rbound) {
            errLog.emitOutOfRangeError(parser, valueType, lbound, rbound);
        }
    }

    public void checkImplementIsNotMain(LP mainProp, LP implProp) throws ScriptingModuleErrorLog.SemanticError {
        if (mainProp == implProp) {
            errLog.emitRecursiveImplementError(parser);
        }
    }

    public void checkNavigatorElementName(String name) throws ScriptingModuleErrorLog.SemanticError {
        if (name == null) {
            errLog.emitNavigatorElementFolderNameError(parser);
        }
    }

    public void checkAssignProperty(LPWithParams fromProperty, LPWithParams toProperty) throws ScriptingModuleErrorLog.SemanticError {
