...
//            return valueFlex;
    ...
    public void customSerialize(ServerSerializationPool pool, DataOutputStream outStream) throws IOException {
        ...
        boolean isPivotColumn = entity.pivotGroupObject != null;
        pool.writeBoolean(outStream, isPivotColumn);
        if(isPivotColumn) {
            pool.serializeObject(outStream, pool.context.view.getGroupObject(pool.context.entity.getGroupObject(entity.pivotGroupObject)));
        } else {
