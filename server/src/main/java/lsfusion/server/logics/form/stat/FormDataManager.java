...
public abstract class FormDataManager {
    ...
    public PrintMessageData getPrintMessageData(SelectTop<Integer> selectTop, boolean removeNullsAndDuplicates) throws SQLException, SQLHandledException {
    ...
    public ExportResult getExportData(SelectTop<Integer> selectTop) throws SQLException, SQLHandledException {
