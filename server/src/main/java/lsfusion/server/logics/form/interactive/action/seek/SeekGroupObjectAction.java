...
public class SeekGroupObjectAction extends SeekAction {
    ...
    protected void executeForm(FormInstance form, ExecutionContext<ClassPropertyInterface> context) throws SQLException, SQLHandledException {
        form.seekObjects(form.instanceFactory.getExInstance(groupObject), objects.mapOrderSetValues(form.instanceFactory::getExInstance).mapOrderValues((int i) -> context.getKeyValue(getOrderInterfaces().get(i))), type, context.stack);
    }
}