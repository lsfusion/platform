...
public class DefaultChangeIntervalObjectAction extends SystemExplicitAction {
    ...
    public DefaultChangeIntervalObjectAction(ObjectEntity objectFrom, ObjectEntity objectTo, ValueClass intervalValueClass) {
        super(LocalizedString.create("CO", false));

        this.intervalValueClass = (IntervalClass) intervalValueClass;
    ...
    protected void executeInternal(ExecutionContext<ClassPropertyInterface> context) throws SQLException, SQLHandledException {
        ...
        ObjectValue changeValue = context.requestUserData(intervalValueClass.getBaseClass(), null, false);
    ...
    private void changeObjects(FormInstance formInstance, ObjectValue changeValue, boolean... positions) throws SQLException, SQLHandledException {
        for (boolean position : positions) {
            ...
            formInstance.changeObject(objectInstance, DataObject.getValue(intervalValueClass.getSingleValue((BigDecimal) changeValue.getValue(), position),
