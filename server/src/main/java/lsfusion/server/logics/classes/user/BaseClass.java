...
public class BaseClass extends AbstractCustomClass {
    ...
    public void fillIDs(SQLSession sql, QueryEnvironment env, SQLCallable<Long> idGen, LP staticCaption, LP staticImage, LP<?> staticName, LP<?> staticCaptionOrder, Map<String, String> sidChanges, Map<String, String> objectSIDChanges, DBManager.IDChanges dbChanges, ChangesController changesController) throws SQLException, SQLHandledException {
        ...
        objectClass.fillIDs(sql, env, idGen, staticCaption, staticImage, staticName, staticCaptionOrder, usedSIds, usedIds, sidChanges, dbChanges);
        ...
        for (CustomClass customClass : allClasses) // заполним все остальные StaticClass
            if (customClass instanceof ConcreteCustomClass)
                ((ConcreteCustomClass) customClass).fillIDs(sql, env, idGen, staticCaption, staticImage, staticName, staticCaptionOrder, usedSIds, usedIds, objectSIDChanges, dbChanges);
