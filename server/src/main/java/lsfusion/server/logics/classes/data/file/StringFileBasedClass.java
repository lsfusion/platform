...
public abstract class StringFileBasedClass extends FileBasedClass<String> implements DBType {

    private final String extension;

    protected StringFileBasedClass(LocalizedString caption, String extension) {
        super(caption);
