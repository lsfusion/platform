...
//        addProperty(null, lcp);
    ...
    protected LAP addExportPropertyAProp(LocalizedString caption, FormIntegrationType type, int resInterfaces, List<String> aliases, List<Boolean> literals, ImOrderMap<String, Boolean> orders, LCP singleExportFile, boolean conditional, String separator, boolean noHeader, boolean noEscape, String charset, Object... params) throws FormEntity.AlreadyDefined {
