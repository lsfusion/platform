...
public class CheckIndicesActionProperty extends ScriptingActionProperty {
    ...
    public void executeCustom(final ExecutionContext<ClassPropertyInterface> context) throws SQLException, SQLHandledException {
        ...
        context.delayUserInterfaction(new MessageClientAction(localize(new FormatLocalizedString("{logics.check.completed}", localize("{logics.checking.indices}"))), localize("{logics.checking.indices}")));
    }
