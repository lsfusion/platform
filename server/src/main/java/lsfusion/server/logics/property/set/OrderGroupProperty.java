...
//            assert groupProps.toSet().containsAll(innerInterfaces.removeIncl(aggrInterface));
    ...
    public ActionMapImplement<?, Interface<I>> getDefaultEventAction(String eventActionSID, ChangeEventScope defaultChangeEventScope, ImList<Property> viewProperties, String customChangeFunction) {
        ...
        if(groupMap != null && !eventActionSID.equals(ServerResponse.EDIT_OBJECT)) {
            ...
            LA<?> la = baseLM.addIFAProp(null, LocalizedString.NONAME, selectForm.form, selectForm.objectsToSet, ChangeEventScope.getScope(defaultChangeEventScope, PropertyDrawEntity.DEFAULT_CUSTOMCHANGE_EVENTSCOPE), true, ModalityWindowFormType.EMBEDDED, null);
