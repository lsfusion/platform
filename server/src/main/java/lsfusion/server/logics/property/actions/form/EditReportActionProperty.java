...
public class EditReportActionProperty extends ReportClientActionProperty {
    private static LCP showIf = createShowIfProperty(new CalcProperty[] {FormEntity.isFullClient, FormEntity.isDebug, FormEntity.isFloat}, new boolean[] {false, false, true});
