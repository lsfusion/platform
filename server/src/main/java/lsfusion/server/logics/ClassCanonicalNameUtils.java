...
public final class ClassCanonicalNameUtils {
    ...
    private static Map<String, DataClass> canonicalDataClassNames = new HashMap<String, DataClass>() {{
        ...
        put("FILE", DynamicFormatFileClass.get(false, false));
        put("EXCELFILE", ExcelClass.get(false, false));
        put("CSVFILE", CSVClass.get(false, false));
        put("HTMLFILE", HTMLClass.get(false, false));
        put("JSONFILE", JSONClass.get(false, false));
        put("XMLFILE", XMLClass.get(false, false));
