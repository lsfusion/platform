...
propertyDefinition[List<TypedParameter> context, boolean dynamic] returns [LP property, List<ResolveClassSet> signature]
	...
	|	exprOrCIPD=propertyExpressionOrContextIndependentPD[context, dynamic] { if($exprOrCIPD.ci != null) { $property = $exprOrCIPD.ci.property; $signature = $exprOrCIPD.ci.signature; } 
                                                    else { if (inPropParseState()) { self.getChecks().checkNecessaryProperty($exprOrCIPD.property); $signature = self.getClassesFromTypedParams(context); $property = $exprOrCIPD.property.property; } }}
...
propertyExpressionOrContextIndependentPD[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	DebugInfo.DebugPoint point = getCurrentDebugPoint();
}
@after{
    if (inPropParseState()) {
        self.propertyDefinitionCreated($ci != null ? $ci.property : $property.property, point);
    }
}
...
ifPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
...
orPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	List<LPWithParams> props = new ArrayList<LPWithParams>();
}
@after {
...
xorPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	List<LPWithParams> props = new ArrayList<LPWithParams>();
}
@after {
...
andPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	List<LPWithParams> props = new ArrayList<LPWithParams>();
}
@after {
...
notPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
...
equalityPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
...
relationalPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	LPWithParams leftProp = null, rightProp = null;
	LP mainProp = null;
	String op = null;
...
additiveORPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	List<LPWithParams> props = new ArrayList<LPWithParams>();
...
additivePE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	List<LPWithParams> props = new ArrayList<LPWithParams>();
	List<String> ops = new ArrayList<String>();
}
...
multiplicativePE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	List<LPWithParams> props = new ArrayList<LPWithParams>();
	List<String> ops = new ArrayList<String>();
}
...
unaryMinusPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci] 
@init {
...
postfixUnaryPE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci] 
@init {	
...
simplePE[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
...
expressionPrimitive[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
...
expressionFriendlyPD[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@after {
...
contextIndependentPD[List<TypedParameter> context, boolean innerPD] returns [LP property, List<ResolveClassSet> signature, List<Integer> usedContext = Collections.emptyList()]
@init {
	DebugInfo.DebugPoint point = getCurrentDebugPoint();
}
@after{
...
groupCDPropertyDefinition[List<TypedParameter> context, boolean dynamic] returns [LPWithParams property, LCPContextIndependent ci]
@init {
	List<TypedParameter> groupContext = new ArrayList<TypedParameter>(context);
}
@after {
	if (inPropParseState()) {
		Pair<LPWithParams, LCPContextIndependent> peOrCI = self.addScriptedCDGProp(context.size(), $exprList.props, $gp.type, $gp.mainProps, $gp.orderProps, $gp.ascending, $gp.whereProp, groupContext);
...
inlineProperty[List<TypedParameter> context] returns [LP property, List<Integer> usedContext]
@init {
	List<TypedParameter> newContext = new ArrayList<TypedParameter>(context);
	List<ResolveClassSet> signature = null;
}
@after {
	...
	:	'[' EQ	(	ciPD=contextIndependentPD[context, true] { $property = $ciPD.property; signature = $ciPD.signature; $usedContext = $ciPD.usedContext; }
				|   exprOrCIPD=propertyExpressionOrContextIndependentPD[newContext, true] { if($exprOrCIPD.ci != null) { $property = $exprOrCIPD.ci.property; signature = $exprOrCIPD.ci.signature; $usedContext = $exprOrCIPD.ci.usedContext; }
                                                                    else { if (inPropParseState()) { self.getChecks().checkNecessaryProperty($exprOrCIPD.property); $property = $exprOrCIPD.property.property; $usedContext = self.getResultInterfaces(context.size(), $exprOrCIPD.property); signature = self.getClassesFromTypedParams(context.size(), $usedContext, newContext);} }}
