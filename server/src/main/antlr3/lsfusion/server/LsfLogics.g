...
@header {
    ...
    import lsfusion.server.language.ActionSettings;
    ...
    import lsfusion.server.language.PropertySettings;
    import lsfusion.server.logics.property.cases.CaseUnionProperty;
    import lsfusion.server.language.ActionOrPropertySettings;
