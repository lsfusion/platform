...
public class ValueClassSet<P extends PropertyInterface> extends SubNodeSet<ChangeClass<P>, ValueClassSet<P>> implements PropertyClass<P> {
    ...
    public ClassSet getValueClass(InterfaceClass<P> interfaceImplement) {
        ...
        if(BusinessLogics.activateCaches) result = cacheValueClass.get(interfaceImplement);
        if(result==null) {
            result = new ClassSet();
            ...
            if(BusinessLogics.activateCaches) cacheValueClass.put(interfaceImplement,result);
        }
        return result;
    }
    ...
    public InterfaceClassSet<P> getClassSet(ClassSet reqValue) {
        ...
        if(BusinessLogics.activateCaches) result = cacheClassSet.get(reqValue);
        if(result==null) {
            ...
            if(BusinessLogics.activateCaches) cacheClassSet.put(reqValue,result);
        }
        return result;
    }
